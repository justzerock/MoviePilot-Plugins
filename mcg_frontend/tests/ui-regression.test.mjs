...
const applePolish = readFileSync(new URL('../../docker-app/frontend/src/styles/applePolish.css', import.meta.url), 'utf8')
...
test('compact headers bind to the plugin scroll root and use shared motion tokens', () => {
