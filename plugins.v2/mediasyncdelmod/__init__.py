...
class MediaSyncDelMod(_PluginBase):
    # 插件名称
    ...
    # 插件作者
    plugin_author = "thsrite, justzerock"
    # 作者主页
    author_url = "https://github.com/justzerock/MoviePilot-Plugins"
    # 插件配置项ID前缀
    plugin_config_prefix = "mediasyncdelmod_"
    # 加载顺序
    plugin_order = 9
    # 可使用的用户级别
    auth_level = 1
                                ...
                                'content': [
                                    {
                                        ...
                                        'props': {
                                            ...
                                            'text': 'Scripter X配置文档：'
                                                    ...
                                                    'MediaSyncDelMod/blob/main/MoviePilot/MoviePilot.md'
                                        }
                                    }
                                ]
                            }
                                ...
                                'content': [
                                    {
                                        ...
                                        'props': {
                                            ...
                                            'variant': 'tonal',
                                            'text': '路径映射配置文档：'
                                                    'https://github.com/thsrite/MediaSyncDelMod/blob/main/path.md'
                                        }
                                    }
                                ]
                            }
                    ...
                    'content': [
                        {
                            ...
                            'events': {
                                'click': {
                                    'api': 'plugin/MediaSyncDelMod/delete_history',
                                    'method': 'get',
                                    'params': {
                                        'key': unique,
