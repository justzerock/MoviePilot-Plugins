...
def create_style_animated_3(library_dir, title, font_path, font_size=(170,75), font_offset=(0,40,40), 
    ...
    try:
        ...
        # 缩放到目标分辨率
        zh_font_size_s = int(main_title_font_size * scale)
        en_font_size_s = int(subtitle_font_size * scale)
        ...
        text_overlay = draw_text_on_image(
            text_overlay, title_zh, (s(73.32), s(427.34) + zh_font_size_s * main_title_font_offset), main_title_font_path, "ch.ttf", zh_font_size_s,
        ...
        if title_en:
            text_overlay, line_count = draw_multiline_text_on_image(
                ...
                subtitle_font_path, "en.otf", en_font_size_s, s(en_line_spacing),
