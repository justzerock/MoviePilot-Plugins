...
import { g as getTemplateFontFamilyStack, c as clearPreviewFontFamily, a as getTemplateFontFaceName, b as applyPreviewFontFamily, S as SEMANTIC_FONT_ITEMS, B as BUILTIN_FONT_ITEMS, d as BlueprintField, e as BlueprintSelect, M as MCR_CONTROL_DEFAULTS, A as AsyncStatusDots, V as ViewportSaveToast } from './ViewportSaveToast-ui-rev-20260715-01.js';
...
function applyPreviewFont(alias, source) {
...
async function ensurePreviewFont(alias, source) {
  ...
  const task = new FontFace(family, `url(${url})`).load().then(async (font) => {
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-25f023c8"]]);
