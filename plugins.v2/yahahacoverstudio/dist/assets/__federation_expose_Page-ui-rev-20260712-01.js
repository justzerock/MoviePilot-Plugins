...
const _hoisted_74 = { class: "mcr-history-card__media" };
const _hoisted_75 = ["aria-pressed", "aria-label", "disabled", "onClick"];
const _hoisted_76 = { class: "mcr-history-card__title" };
const _hoisted_77 = { class: "mcr-history-card__actions" };
const _hoisted_78 = { class: "mcr-history-card__meta" };
const _hoisted_79 = {
  key: 0,
  class: "mcr-time-machine-more"
};
const _hoisted_80 = {
  key: 1,
...
const _hoisted_84 = { class: "mcr-donation-title" };
const _hoisted_85 = { class: "mcr-donation-subtitle" };
const _hoisted_86 = {
...
const _hoisted_90 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--static" };
const _hoisted_91 = { class: "mcr-donation-stat-card" };
const _hoisted_92 = { class: "mcr-donation-stat-card__top" };
const _hoisted_93 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--dynamic" };
const _hoisted_94 = { class: "mcr-donation-stat-card" };
const _hoisted_95 = { class: "mcr-donation-stat-card__top" };
const _hoisted_96 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--history" };
const _hoisted_97 = { class: "mcr-donation-stat-card" };
const _hoisted_98 = { class: "mcr-donation-stat-card__top" };
const _hoisted_99 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--run" };
const _hoisted_100 = {
  key: 3,
...
const _hoisted_103 = { class: "mcr-donation-card__actions" };
const _hoisted_104 = {
  key: 5,
...
将把此时保存的封面重新应用到对应服务器媒体库。当前封面会被替换，但历史记录不会删除。`)) return;
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", {
        ...
        _cache[114] || (_cache[114] = _createElementVNode("div", { class: "mcr-shell__aurora" }, null, -1)),
        _cache[115] || (_cache[115] = _createElementVNode("div", { class: "mcr-shell__noise" }, null, -1)),
                      ...
                      _createElementVNode("div", _hoisted_3, [
                        _createElementVNode("div", _hoisted_4, [
                          _createElementVNode("div", _hoisted_5, [
                            ...
                            _cache[49] || (_cache[49] = _createElementVNode("h1", {
                                    ...
                                    _withDirectives(_createElementVNode("div", {
                                      ...
                                      animatedSettingsPanelOpen.value ? (_openBlock(), _createElementBlock("div", _hoisted_45, [
                                        _createElementVNode("div", _hoisted_46, [
                                          ...
                                          _createElementVNode("div", null, [
                                            _cache[66] || (_cache[66] = _createElementVNode("span", null, "Motion Settings", -1)),
                              ...
                              pageTab.value === "history-tab" && historyGroupMode.value === "time-machine" && groupedHistory.value.length ? (_openBlock(), _createElementBlock("nav", {
                                ...
                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedHistory.value, (group) => {
                                  return _openBlock(), _createElementBlock("button", {
                                    ...
                                    _cache[79] || (_cache[79] = _createElementVNode("i", { "aria-hidden": "true" }, null, -1)),
                                    ...
                                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedHistory.value, (group) => {
                                      return _openBlock(), _createElementBlock("section", {
                                        ...
                                        _createVNode(_component_v_row, null, {
                                          default: _withCtx(() => [
                                            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(historyGroupMode.value === "time-machine" ? group.items.slice(0, 6) : group.items, (item) => {
                                                  ...
                                                  _createVNode(_component_v_card, {
                                                    ...
                                                    default: _withCtx(() => [
                                                      _createElementVNode("div", _hoisted_74, [
                                                        ...
                                                        _createElementVNode("div", _hoisted_76, _toDisplayString(item.library || item.name), 1),
                                                      ...
                                                      _createVNode(_component_v_card_text, { class: "mcr-panel__body mcr-panel__body--tight" }, {
                                                        default: _withCtx(() => [
                                                          _createElementVNode("div", _hoisted_78, _toDisplayString(item.server || "Unknown") + " · " + _toDisplayString(item.date_label || item.mtime || "--") + " · " + _toDisplayString(item.size), 1)
                                                        ]),
                                                        _: 2
                                                      }, 1024)
                                                    ]),
                                        ...
                                        historyGroupMode.value === "time-machine" && group.items.length > 6 ? (_openBlock(), _createElementBlock("div", _hoisted_79, "+" + _toDisplayString(group.items.length - 6), 1)) : _createCommentVNode("", true)
                                      ], 10, _hoisted_71);
                                    }), 128))
                                  ])) : (_openBlock(), _createElementBlock("div", _hoisted_80, [..._cache[83] || (_cache[83] = [
        ...
        _createVNode(_component_v_dialog, {
          ...
          "onUpdate:modelValue": _cache[39] || (_cache[39] = ($event) => donationDialog.value = $event),
          "max-width": "460",
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_card_text, { class: "mcr-donation-card__body" }, {
                  default: _withCtx(() => [
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_81, [
                      _createElementVNode("div", {
                        ...
                        donationAvatarImage.value ? (_openBlock(), _createElementBlock("img", {
                          ...
                          src: donationAvatarImage.value,
                          alt: ""
                        }, null, 8, _hoisted_82)) : (_openBlock(), _createBlock(_component_v_icon, {
                          key: 1,
                          icon: donationAvatarIcon.value,
                          size: "38"
                        }, null, 8, ["icon"])),
                      ...
                      _createElementVNode("h3", _hoisted_84, _toDisplayString(donationView.value === "support" ? "感谢您的支持" : "呀哈哈封面工坊"), 1),
                      _createElementVNode("div", _hoisted_85, _toDisplayString(donationView.value === "support" ? "Heartfelt giving" : "使用数据统计"), 1)
                    ])) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                      ...
                      _cache[84] || (_cache[84] = _createElementVNode("h3", { class: "mcr-donation-title" }, "感谢您的支持", -1))
                    ], 64)),
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_87, [
                      _createElementVNode("div", _hoisted_88, [
                        _createElementVNode("div", _hoisted_89, [
                          ...
                          _cache[85] || (_cache[85] = _createElementVNode("small", null, "Active", -1))
                        ]),
                        _createElementVNode("strong", null, _toDisplayString(donationStaticSchemeCount.value), 1),
                        _cache[86] || (_cache[86] = _createElementVNode("span", null, "静态方案", -1))
                      ]),
                      ...
                      _createElementVNode("div", _hoisted_94, [
                        ...
                        _cache[89] || (_cache[89] = _createElementVNode("span", null, "历史封面", -1))
                      ]),
                      _createElementVNode("div", _hoisted_97, [
                        ...
                        _cache[90] || (_cache[90] = _createElementVNode("span", null, "执行次数", -1))
                      ])
                    ])) : _createCommentVNode("", true),
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_100, [
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("p", _hoisted_102, " 您的慷慨支持是我持续创作的动力。 ")) : _createCommentVNode("", true),
                    _createElementVNode("div", _hoisted_103, [
                      donationView.value === "support" ? (_openBlock(), _createBlock(_component_v_btn, {
                        ...
                        onClick: _cache[37] || (_cache[37] = ($event) => donationDialog.value = false)
                      }, {
                      ...
                      donationView.value === "overview" ? (_openBlock(), _createBlock(_component_v_btn, {
                        ...
                        onClick: _cache[38] || (_cache[38] = ($event) => donationView.value = "support")
                      }, {
                        default: _withCtx(() => [
                          _createVNode(_component_v_icon, {
                          ...
                          _cache[92] || (_cache[92] = _createElementVNode("span", null, "继续支持", -1))
                        ]),
                        _: 1
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[93] || (_cache[93] = _createElementVNode("span", null, "已支持", -1))
                        ]),
                        _: 1
                      }))
                    ]),
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_104, "HEARTFELT GIVING • LUMINOUS CHARITY")) : _createCommentVNode("", true)
                  ]),
                  _: 1
                })
              ]),
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-64057856"]]);
