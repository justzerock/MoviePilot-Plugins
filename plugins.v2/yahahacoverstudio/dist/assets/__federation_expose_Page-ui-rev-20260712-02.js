import { importShared } from './__federation_fn_import-ui-rev-20260712-02.js';
import { _ as _export_sfc } from './_plugin-vue_export-helper-ui-rev-20260712-02.js';
import { g as getTemplateFontFamilyStack, S as SEMANTIC_FONT_ITEMS, B as BUILTIN_FONT_ITEMS, a as getTemplateFontFaceName, b as BlueprintField, c as BlueprintSelect, M as MCR_CONTROL_DEFAULTS, A as AsyncStatusDots, V as ViewportSaveToast } from './ViewportSaveToast-ui-rev-20260712-02.js';
...
const _hoisted_63 = ["data-mcr-theme"];
const _hoisted_64 = { class: "mcr-history-selection-count" };
...
const _hoisted_72 = { class: "mcr-history-group__heading" };
const _hoisted_73 = { class: "mcr-history-group__title" };
const _hoisted_74 = ["aria-label", "onClick"];
const _hoisted_75 = ["src", "alt"];
const _hoisted_76 = {
  key: 0,
  class: "mcr-time-machine-stack__more"
};
const _hoisted_77 = { class: "mcr-history-card__media" };
const _hoisted_78 = ["aria-pressed", "aria-label", "disabled", "onClick"];
const _hoisted_79 = { class: "mcr-history-card__title" };
const _hoisted_80 = { class: "mcr-history-card__actions" };
const _hoisted_81 = { class: "mcr-history-card__meta" };
const _hoisted_82 = {
  key: 1,
  class: "mcr-history-empty"
};
const _hoisted_83 = { class: "mcr-history-snapshot__header" };
const _hoisted_84 = { class: "mcr-history-snapshot__grid" };
const _hoisted_85 = ["src", "alt"];
const _hoisted_86 = { class: "mcr-history-snapshot__footer" };
const _hoisted_87 = {
  key: 0,
...
const _hoisted_90 = { class: "mcr-donation-title" };
const _hoisted_91 = { class: "mcr-donation-subtitle" };
const _hoisted_92 = {
...
const _hoisted_96 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--static" };
const _hoisted_97 = { class: "mcr-donation-stat-card" };
const _hoisted_98 = { class: "mcr-donation-stat-card__top" };
const _hoisted_99 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--dynamic" };
const _hoisted_100 = { class: "mcr-donation-stat-card" };
const _hoisted_101 = { class: "mcr-donation-stat-card__top" };
const _hoisted_102 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--history" };
const _hoisted_103 = { class: "mcr-donation-stat-card" };
const _hoisted_104 = { class: "mcr-donation-stat-card__top" };
const _hoisted_105 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--run" };
const _hoisted_106 = {
  key: 3,
  class: "mcr-donation-qr"
};
const _hoisted_107 = ["src"];
const _hoisted_108 = {
  key: 4,
  class: "mcr-donation-message"
};
const _hoisted_109 = { class: "mcr-donation-card__actions" };
const _hoisted_110 = {
  key: 5,
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function loadPreviewSources(requiredItems) {
      if (!componentActive) return;
      if (isGenerating.value) {
    ...
    async function deleteCover(item) {
      if (shouldBlockLockedAction()) return;
      try {
        const url = `plugin/YahahaCoverStudio/delete_saved_cover?file=${encodeURIComponent(item.path)}`;
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", {
                      ...
                      _createElementVNode("div", _hoisted_3, [
                        _createElementVNode("div", _hoisted_4, [
                          _createElementVNode("div", _hoisted_5, [
                            ...
                            _cache[54] || (_cache[54] = _createElementVNode("h1", {
                              ...
                              _createElementVNode("section", {
                                ...
                                !isEditingLayout.value ? (_openBlock(), _createElementBlock("div", _hoisted_30, [
                                  _createElementVNode("label", _hoisted_31, [
                                    _cache[62] || (_cache[62] = _createElementVNode("span", null, "海报来源", -1)),
                                  ...
                                  _createElementVNode("label", _hoisted_33, [
                                    _createElementVNode("span", _hoisted_34, [
                                      _cache[63] || (_cache[63] = _createElementVNode("span", null, "封面来源排序", -1)),
                                    ...
                                    _withDirectives(_createElementVNode("select", {
                                      ...
                                      _cache[64] || (_cache[64] = _createElementVNode("option", { value: "Random" }, "随机", -1)),
                                      _createElementVNode("option", _hoisted_37, _toDisplayString(sourceSortLocked.value ? "最新入库（已锁定）" : "最新入库"), 1),
                                      _cache[65] || (_cache[65] = _createElementVNode("option", { value: "PremiereDate" }, "最新发行", -1))
                                    ], 40, _hoisted_36), [
                                      [_vModelSelect, sourceSortBy.value]
                                    ])
                                  ]),
                                  _createElementVNode("label", _hoisted_38, [
                                    _cache[67] || (_cache[67] = _createElementVNode("span", null, "分辨率", -1)),
                              ...
                              !isEditingLayout.value ? (_openBlock(), _createElementBlock("aside", {
                                ...
                                _createElementVNode("div", {
                                  ...
                                  _createElementVNode("div", _hoisted_42, [
                                    _cache[69] || (_cache[69] = _createElementVNode("div", { class: "mcr-panel__eyebrow" }, "Presets", -1)),
                                    _createElementVNode("div", _hoisted_43, [
                                      _cache[68] || (_cache[68] = _createTextVNode(" 封面方案 ", -1)),
                                      _createVNode(_component_v_icon, {
                                        icon: "mdi-chevron-up",
                                        size: "20",
                                    ...
                                    _withDirectives(_createElementVNode("div", {
                                      ...
                                      animatedSettingsPanelOpen.value ? (_openBlock(), _createElementBlock("div", _hoisted_45, [
                                        _createElementVNode("div", _hoisted_46, [
                                          ...
                                          _createElementVNode("div", null, [
                                            _cache[71] || (_cache[71] = _createElementVNode("span", null, "Motion Settings", -1)),
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", {
                              ...
                              _createElementVNode("div", _hoisted_58, [
                                _cache[81] || (_cache[81] = _createElementVNode("div", { class: "mcr-panel__eyebrow" }, "History", -1)),
                                _createElementVNode("div", _hoisted_59, [
                                  _cache[80] || (_cache[80] = _createTextVNode(" 历史封面 ", -1)),
                                  _createVNode(_component_v_icon, {
                                    icon: "mdi-chevron-up",
                                    size: "20",
                                    class: "mcr-collapsible-heading__icon",
                              ...
                              pageTab.value === "history-tab" && historyGroupMode.value === "time-machine" && groupedHistory.value.length ? (_openBlock(), _createElementBlock("nav", {
                                ...
                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedHistory.value, (group) => {
                                  return _openBlock(), _createElementBlock("button", {
                                    ...
                                    }, "回到此时", 8, _hoisted_62)) : _createCommentVNode("", true),
                                    _cache[84] || (_cache[84] = _createElementVNode("i", { "aria-hidden": "true" }, null, -1)),
                                    _createElementVNode("span", null, _toDisplayString(group.title), 1)
                                  ], 10, _hoisted_61);
                                }), 128))
                              ], 8, _hoisted_60)) : _createCommentVNode("", true)
                            ])),
                            (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
                              pageTab.value === "history-tab" && !historyListCollapsed.value && selectedHistoryPaths.value.length ? (_openBlock(), _createElementBlock("div", {
                                ...
                                _createElementVNode("span", _hoisted_64, "已选择 " + _toDisplayString(selectedHistoryPaths.value.length), 1),
                                _createElementVNode("button", {
                                  type: "button",
                                ...
                                }, _toDisplayString(allHistorySelected.value ? "取消全选" : "全选"), 41, _hoisted_65),
                                _createElementVNode("button", {
                                  type: "button",
                              ...
                              ], 12, _hoisted_63)) : _createCommentVNode("", true)
                            ])),
                            _createVNode(_Transition, { name: "mcr-list-collapse" }, {
                              default: _withCtx(() => [
                                _withDirectives(_createElementVNode("div", _hoisted_69, [
                                  history.value.length ? (_openBlock(), _createElementBlock("div", _hoisted_70, [
                                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedHistory.value, (group) => {
                                      return _openBlock(), _createElementBlock("section", {
                                        ...
                                        _createElementVNode("div", _hoisted_72, [
                                          ...
                                          _createVNode(_component_v_btn, {
                                            ...
                                            disabled: controlsLocked.value,
                                            onClick: ($event) => toggleHistoryGroupSelection(group)
                                          }, {
                                            default: _withCtx(() => [
                                              _createTextVNode(_toDisplayString(isHistoryGroupSelected(group) ? "取消本组" : "选择本组"), 1)
                                            ]),
                                            _: 2
                                        ...
                                        historyGroupMode.value === "time-machine" ? (_openBlock(), _createElementBlock("button", {
                                          ...
                                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(group.items.slice(0, historyStackLimit.value), (item) => {
                                          ...
                                          group.items.length > historyStackLimit.value ? (_openBlock(), _createElementBlock("span", _hoisted_76, "+" + _toDisplayString(group.items.length - historyStackLimit.value), 1)) : _createCommentVNode("", true)
                                        ], 8, _hoisted_74)) : (_openBlock(), _createBlock(_component_v_row, { key: 1 }, {
                                          default: _withCtx(() => [
                                                  ...
                                                  _createVNode(_component_v_card, {
                                                    ...
                                                    default: _withCtx(() => [
                                                      _createElementVNode("div", _hoisted_77, [
                                                        ...
                                                        _createElementVNode("div", _hoisted_79, _toDisplayString(item.library || item.name), 1),
                                                        _createElementVNode("div", _hoisted_80, [
                                                          _createVNode(_component_v_btn, {
                                                            ...
                                                            disabled: controlsLocked.value,
                                                            onClick: ($event) => downloadCover(item)
                                                          }, {
                                                          ...
                                                          _createVNode(_component_v_btn, {
                                                            ...
                                                            disabled: controlsLocked.value,
                                                            onClick: ($event) => deleteCover(item)
                                                          }, {
                                                      ...
                                                      _createVNode(_component_v_card_text, { class: "mcr-panel__body mcr-panel__body--tight" }, {
                                                        default: _withCtx(() => [
                                                          _createElementVNode("div", _hoisted_81, _toDisplayString(item.server || "Unknown") + " · " + _toDisplayString(item.date_label || item.mtime || "--") + " · " + _toDisplayString(item.size), 1)
                                                        ]),
                                                        _: 2
                                                      }, 1024)
                                                    ]),
                                  ...
                                  ])) : (_openBlock(), _createElementBlock("div", _hoisted_82, [..._cache[88] || (_cache[88] = [
        ...
        _createVNode(_component_v_dialog, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card, {
              ...
              default: _withCtx(() => [
                _cache[91] || (_cache[91] = _createElementVNode("h3", null, "确定回到此时吗？", -1)),
                _createElementVNode("p", null, _toDisplayString(pendingHistoryRestore.value?.label), 1),
                _cache[92] || (_cache[92] = _createElementVNode("p", null, "将把该时间保存的封面重新应用到对应服务器媒体库。当前服务器上的封面会被替换，但历史记录不会被删除。", -1)),
        ...
        _createVNode(_component_v_dialog, {
          ...
          "onUpdate:modelValue": _cache[41] || (_cache[41] = ($event) => historySnapshotDialog.value = $event),
          "max-width": "1120",
            ...
            selectedHistorySnapshot.value ? (_openBlock(), _createBlock(_component_v_card, {
              ...
              default: _withCtx(() => [
                _createElementVNode("header", _hoisted_83, [
                  _createElementVNode("div", null, [
                    _cache[93] || (_cache[93] = _createElementVNode("span", null, "History", -1)),
                    _cache[94] || (_cache[94] = _createElementVNode("h3", null, "此时的封面", -1)),
                  ...
                  _createVNode(_component_v_btn, {
                    ...
                    variant: "text",
                    "aria-label": "关闭",
                    onClick: _cache[39] || (_cache[39] = ($event) => historySnapshotDialog.value = false)
                  })
                ]),
                _createElementVNode("div", _hoisted_84, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedHistorySnapshot.value.items, (item) => {
                    return _openBlock(), _createElementBlock("article", {
                      key: item.path,
                      class: "mcr-history-snapshot__item"
                    }, [
                      _createElementVNode("img", {
                        src: item.src || item.url || "",
                        alt: item.library || item.name,
                      ...
                      _createElementVNode("div", null, [
                        _createElementVNode("strong", null, _toDisplayString(item.library || item.name), 1),
                        _createElementVNode("span", null, _toDisplayString(item.server || "未知服务器"), 1),
                        _createElementVNode("small", null, _toDisplayString(item.uploaded === false ? "上传失败" : "已生成并保存"), 1)
                      ]),
                      _createVNode(_component_v_btn, {
                        size: "small",
                        "prepend-icon": "mdi-download-outline",
                ...
                _createElementVNode("footer", _hoisted_86, [
                  _createVNode(_component_v_btn, {
                    class: "mcr-button mcr-button--primary",
                    "prepend-icon": "mdi-history",
                    loading: restoringBatchId.value === selectedHistorySnapshot.value.key,
                    onClick: _cache[40] || (_cache[40] = ($event) => restoreHistoryBatch(selectedHistorySnapshot.value.key, selectedHistorySnapshot.value.title))
                  }, {
            ...
            _createVNode(_component_v_card, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_card_text, { class: "mcr-donation-card__body" }, {
                  default: _withCtx(() => [
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_87, [
                      _createElementVNode("div", {
                        ...
                        donationAvatarImage.value ? (_openBlock(), _createElementBlock("img", {
                          ...
                          src: donationAvatarImage.value,
                          alt: ""
                        }, null, 8, _hoisted_88)) : (_openBlock(), _createBlock(_component_v_icon, {
                          key: 1,
                          icon: donationAvatarIcon.value,
                          size: "38"
                        }, null, 8, ["icon"])),
                      ...
                      _createElementVNode("h3", _hoisted_90, _toDisplayString(donationView.value === "support" ? "感谢您的支持" : "呀哈哈封面工坊"), 1),
                      _createElementVNode("div", _hoisted_91, _toDisplayString(donationView.value === "support" ? "Heartfelt giving" : "使用数据统计"), 1)
                    ])) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                    ...
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_93, [
                      _createElementVNode("div", _hoisted_94, [
                        _createElementVNode("div", _hoisted_95, [
                          ...
                          _cache[98] || (_cache[98] = _createElementVNode("small", null, "Active", -1))
                        ]),
                      ...
                      _createElementVNode("div", _hoisted_100, [
                        ...
                        _cache[102] || (_cache[102] = _createElementVNode("span", null, "历史封面", -1))
                      ]),
                      _createElementVNode("div", _hoisted_103, [
                        ...
                        _cache[103] || (_cache[103] = _createElementVNode("span", null, "执行次数", -1))
                      ])
                    ])) : _createCommentVNode("", true),
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_106, [
                      _createElementVNode("img", {
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("p", _hoisted_108, " 您的慷慨支持是我持续创作的动力。 ")) : _createCommentVNode("", true),
                    _createElementVNode("div", _hoisted_109, [
                      ...
                      donationView.value === "overview" ? (_openBlock(), _createBlock(_component_v_btn, {
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[105] || (_cache[105] = _createElementVNode("span", null, "继续支持", -1))
                        ]),
                        _: 1
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[106] || (_cache[106] = _createElementVNode("span", null, "已支持", -1))
                        ]),
                        _: 1
                      }))
                    ]),
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_110, "HEARTFELT GIVING • LUMINOUS CHARITY")) : _createCommentVNode("", true)
                  ]),
                  _: 1
                })
              ]),
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1f6634f2"]]);
