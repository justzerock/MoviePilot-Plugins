...
const {toDisplayString:_toDisplayString$2,openBlock:_openBlock$2,createElementBlock:_createElementBlock$2,createCommentVNode:_createCommentVNode$2,mergeProps:_mergeProps$1,normalizeClass:_normalizeClass$1} = await importShared('vue');
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$2(), _createElementBlock$2("label", {
        ...
        __props.textarea ? (_openBlock$2(), _createElementBlock$2("textarea", _mergeProps$1({ key: 1 }, controlAttrs.value, {
          class: "mcr-blueprint-field__control mcr-blueprint-field__control--textarea",
          value: __props.modelValue ?? "",
          rows: __props.rows,
          placeholder: __props.placeholder,
          onInput
        }), null, 16, _hoisted_2$2)) : (_openBlock$2(), _createElementBlock$2("input", _mergeProps$1({ key: 2 }, controlAttrs.value, {
        ...
        __props.hint ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_4$1, _toDisplayString$2(__props.hint), 1)) : _createCommentVNode$2("", true)
      ], 2);
    };
  }
});

const BlueprintField = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-a72d892d"]]);

const {defineComponent:_defineComponent$1} = await importShared('vue');

const {toDisplayString:_toDisplayString$1,openBlock:_openBlock$1,createElementBlock:_createElementBlock$1,createCommentVNode:_createCommentVNode$1,renderList:_renderList,Fragment:_Fragment,createElementVNode:_createElementVNode$1,withModifiers:_withModifiers,normalizeClass:_normalizeClass,normalizeStyle:_normalizeStyle,Teleport:_Teleport,createBlock:_createBlock,mergeProps:_mergeProps} = await importShared('vue');
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$1(), _createElementBlock$1("label", {
        ...
        __props.label ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_1$1, _toDisplayString$1(__props.label), 1)) : _createCommentVNode$1("", true),
        __props.multiple ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_2$1, [
          _createElementVNode$1("button", {
            ...
            selectedItems.value.length ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_4, [
              (_openBlock$1(true), _createElementBlock$1(_Fragment, null, _renderList(visibleSelectedItems.value, (item) => {
                return _openBlock$1(), _createElementBlock$1("span", {
                  key: String(item.value),
                  class: "mcr-blueprint-select__chip"
                }, _toDisplayString$1(item.title), 1);
              }), 128)),
              hiddenSelectedCount.value > 0 ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_5, " ··· ")) : _createCommentVNode$1("", true)
            ])) : (_openBlock$1(), _createElementBlock$1("span", _hoisted_6, _toDisplayString$1(__props.placeholder || "不指定，默认全部"), 1)),
            _createElementVNode$1("span", _hoisted_7, _toDisplayString$1(selectedItems.value.length || normalizedItems.value.length), 1)
          ], 10, _hoisted_3),
          (_openBlock$1(), _createBlock(_Teleport, { to: "body" }, [
            isOpen.value ? (_openBlock$1(), _createElementBlock$1("span", {
              key: 0,
              ref_key: "popoverEl",
              ref: popoverEl,
              ...
              (_openBlock$1(true), _createElementBlock$1(_Fragment, null, _renderList(normalizedItems.value, (item) => {
                return _openBlock$1(), _createElementBlock$1("button", {
                  ...
                  _createElementVNode$1("span", _hoisted_10, [
                    isSelected(item.value) ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_11, "✓")) : _createCommentVNode$1("", true)
                  ]),
                  _createElementVNode$1("span", _hoisted_12, _toDisplayString$1(item.title), 1)
                ], 42, _hoisted_9);
              }), 128)),
              _createElementVNode$1("button", {
                type: "button",
            ...
            ], 14, _hoisted_8)) : _createCommentVNode$1("", true)
          ]))
        ])) : (_openBlock$1(), _createElementBlock$1("span", _hoisted_13, [
          _createElementVNode$1("select", _mergeProps(controlAttrs.value, {
            class: "mcr-blueprint-select__control",
            value: selectValue.value,
            onChange
          }), [
            __props.clearable ? (_openBlock$1(), _createElementBlock$1("option", _hoisted_15, _toDisplayString$1(__props.placeholder || "不指定"), 1)) : _createCommentVNode$1("", true),
            (_openBlock$1(true), _createElementBlock$1(_Fragment, null, _renderList(normalizedItems.value, (item) => {
              return _openBlock$1(), _createElementBlock$1("option", {
                key: String(item.value),
                value: item.value
              }, _toDisplayString$1(item.title), 9, _hoisted_16);
            }), 128))
          ], 16, _hoisted_14)
        ])),
        __props.clearable && __props.multiple && selectedCount.value > 0 ? (_openBlock$1(), _createElementBlock$1("button", {
          key: 3,
          type: "button",
          class: "mcr-blueprint-select__clear",
          onClick: _withModifiers(clearMultiple, ["prevent"])
        }, " 清除已选 " + _toDisplayString$1(selectedCount.value) + " 项 ", 1)) : _createCommentVNode$1("", true),
        __props.hint ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_17, _toDisplayString$1(__props.hint), 1)) : _createCommentVNode$1("", true)
      ], 2);
    };
  }
});

const BlueprintSelect = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1e7ebd55"]]);

const {defineComponent:_defineComponent} = await importShared('vue');

const {createElementVNode:_createElementVNode,toDisplayString:_toDisplayString,openBlock:_openBlock,createElementBlock:_createElementBlock,createCommentVNode:_createCommentVNode} = await importShared('vue');
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("span", _hoisted_1, [
        ...
        __props.label ? (_openBlock(), _createElementBlock("span", _hoisted_2, _toDisplayString(__props.label), 1)) : _createCommentVNode("", true)
      ]);
    };
  }
});

const AsyncStatusDots = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-534605a2"]]);
...
export { AsyncStatusDots as A, BUILTIN_FONT_ITEMS as B, MCR_CONTROL_DEFAULTS as M, SEMANTIC_FONT_ITEMS as S, getTemplateFontFaceName as a, BlueprintField as b, BlueprintSelect as c, getTemplateFontFamilyStack as g };
