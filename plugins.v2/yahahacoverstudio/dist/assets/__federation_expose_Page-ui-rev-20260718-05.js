...
import { g as getTemplateFontFamilyStack, S as SEMANTIC_FONT_ITEMS, B as BUILTIN_FONT_ITEMS, l as loadPreviewFontFaces, a as BlueprintField, b as BlueprintSelect, c as getTemplateFontFaceName, M as MCR_CONTROL_DEFAULTS, A as AsyncStatusDots, V as ViewportSaveToast } from './ViewportSaveToast-ui-rev-20260718-05.js';
...
const _hoisted_129 = { class: "yh-compact-page-header__actions" };
const _hoisted_130 = ["title", "aria-label", "disabled"];
const _hoisted_131 = { class: "yh-run-content" };
const _hoisted_132 = {
  key: 0,
  class: "yh-run-count"
};
                ...
                _createElementVNode("div", _hoisted_129, [
                  _createElementVNode("button", {
                    ...
                    _createElementVNode("span", _hoisted_131, [
                      ...
                      isGenerating.value ? (_openBlock(), _createElementBlock("span", _hoisted_132, _toDisplayString(generationProgressCount.value), 1)) : _createCommentVNode("", true)
                    ])
                  ], 14, _hoisted_130),
                  _createVNode(_component_v_btn, {
                    class: "mcr-button mcr-button--ghost mcr-button--dark-neutral yh-icon-btn",
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d3cd49d6"]]);
