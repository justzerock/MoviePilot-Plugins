...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const history = ref([]);
    const historyGroupMode = ref("date");
    ...
    const groupedHistory = computed(() => {
      ...
      for (const item of sortedHistory.value) {
        const key = historyGroupMode.value === "date" ? item.date || "unknown-date" : item.library || "未识别媒体库";
        const title = historyGroupMode.value === "date" ? item.date || "未知日期" : item.library || "未识别媒体库";
        if (!groups.has(key)) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", {
        ...
        _cache[112] || (_cache[112] = _createElementVNode("div", { class: "mcr-shell__aurora" }, null, -1)),
        _cache[113] || (_cache[113] = _createElementVNode("div", { class: "mcr-shell__noise" }, null, -1)),
                                  ...
                                  !historyListCollapsed.value ? (_openBlock(), _createElementBlock("div", {
                                    ...
                                    _createVNode(_component_v_btn_toggle, {
                                      ...
                                      default: _withCtx(() => [
                                        ...
                                        _createVNode(_component_v_btn, {
                                          value: "date",
                                          class: _normalizeClass(["mcr-button mcr-button--ghost mcr-history-mode-button", { "mcr-history-mode-button--active": historyGroupMode.value === "date" }])
                                        }, {
                                          default: _withCtx(() => [..._cache[78] || (_cache[78] = [
                                            _createTextVNode(" 日期 ", -1)
                                          ])]),
                                          _: 1
                                        }, 8, ["class"])
                                      ]),
                    ...
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_84, [
                      _createElementVNode("div", _hoisted_85, [
                        _createElementVNode("div", _hoisted_86, [
                          ...
                          _cache[83] || (_cache[83] = _createElementVNode("small", null, "Active", -1))
                        ]),
                      ...
                      _createElementVNode("div", _hoisted_88, [
                        _createElementVNode("div", _hoisted_89, [
                          ...
                          _cache[85] || (_cache[85] = _createElementVNode("small", {
                    ...
                    _createElementVNode("div", _hoisted_100, [
                      ...
                      donationView.value === "overview" ? (_openBlock(), _createBlock(_component_v_btn, {
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[90] || (_cache[90] = _createElementVNode("span", null, "继续支持", -1))
                        ]),
                        _: 1
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[91] || (_cache[91] = _createElementVNode("span", null, "已支持", -1))
                        ]),
                        _: 1
                      }))
                    ]),
