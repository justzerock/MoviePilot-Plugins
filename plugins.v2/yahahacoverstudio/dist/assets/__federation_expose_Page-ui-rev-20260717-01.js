import { importShared } from './__federation_fn_import-ui-rev-20260717-01.js';
import { _ as _export_sfc } from './_plugin-vue_export-helper-ui-rev-20260717-01.js';
import { g as getTemplateFontFamilyStack, c as clearPreviewFontFamily, a as applyPreviewFontFamily, S as SEMANTIC_FONT_ITEMS, B as BUILTIN_FONT_ITEMS, b as BlueprintField, d as BlueprintSelect, M as MCR_CONTROL_DEFAULTS, A as AsyncStatusDots, V as ViewportSaveToast } from './ViewportSaveToast-ui-rev-20260717-01.js';
...
const HistoryPosterStack = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-5ef0fee3"]]);
...
const HistoryExpansionLayer = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7207d448"]]);
...
const _hoisted_20 = { class: "blueprint-panel-heading" };
const _hoisted_21 = { class: "mcr-panel__eyebrow" };
const _hoisted_22 = { class: "mcr-panel__title" };
const _hoisted_23 = ["aria-label", "aria-busy", "disabled"];
const _hoisted_24 = {
...
const _hoisted_71 = ["aria-current", "aria-label", "onClick"];
const _hoisted_72 = {
  key: 1,
...
const _hoisted_76 = { class: "mcr-donation-title" };
const _hoisted_77 = { class: "mcr-donation-subtitle" };
const _hoisted_78 = {
...
const _hoisted_80 = { class: "mcr-donation-stat-card" };
const _hoisted_81 = { class: "mcr-donation-stat-card__top" };
const _hoisted_82 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--static" };
const _hoisted_83 = { class: "mcr-donation-stat-card" };
const _hoisted_84 = { class: "mcr-donation-stat-card__top" };
const _hoisted_85 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--dynamic" };
const _hoisted_86 = { class: "mcr-donation-stat-card" };
const _hoisted_87 = { class: "mcr-donation-stat-card__top" };
const _hoisted_88 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--history" };
const _hoisted_89 = { class: "mcr-donation-stat-card" };
const _hoisted_90 = { class: "mcr-donation-stat-card__top" };
const _hoisted_91 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--run" };
const _hoisted_92 = {
  key: 3,
...
const _hoisted_95 = { class: "mcr-donation-card__actions" };
const _hoisted_96 = {
  key: 5,
                      ...
                      _createElementVNode("div", _hoisted_3, [
                        ...
                        _createElementVNode("div", _hoisted_8, [
                          _createElementVNode("div", _hoisted_9, [
                            ...
                            _createElementVNode("button", {
                              ...
                              _createElementVNode("span", _hoisted_13, [
                                ...
                                isGenerating.value ? (_openBlock(), _createElementBlock("span", _hoisted_14, _toDisplayString(generationProgressCount.value), 1)) : _createCommentVNode("", true)
                              ])
                            ], 14, _hoisted_12),
                          ...
                          _createElementVNode("div", _hoisted_15, [
                            ...
                            sourceSortLocked.value ? (_openBlock(), _createElementBlock("span", _hoisted_16, "最新入库排序已锁定")) : _createCommentVNode("", true)
                          ]),
                              ...
                              _createElementVNode("section", {
                                ...
                                _createElementVNode("div", _hoisted_20, [
                                  _createElementVNode("div", null, [
                                    _createElementVNode("div", _hoisted_21, _toDisplayString(isEditingLayout.value ? "Editor" : "Canvas"), 1),
                                    _createElementVNode("div", _hoisted_22, _toDisplayString(isEditingLayout.value ? "画布编辑" : previewModeLabel.value), 1)
                                  ]),
                          ...
                          default: _withCtx(() => [
                            ...
                            (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
                              expandedHistoryGroupId.value && selectedHistoryPaths.value.length ? (_openBlock(), _createElementBlock("div", {
                                ...
                                }, "应用", 8, _hoisted_66)) : _createCommentVNode("", true),
                                _createElementVNode("button", {
                                  type: "button",
                                  ...
                                  history.value.length ? (_openBlock(), _createElementBlock("div", {
                                    ...
                                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedHistory.value, (group) => {
                                      return _openBlock(), _createElementBlock("section", {
                                        ...
                                        historyGroupMode.value === "time-machine" ? (_openBlock(), _createElementBlock("aside", _hoisted_70, [
                                        ...
                                        ])], 10, _hoisted_71)) : _createCommentVNode("", true),
                                        _createVNode(HistoryPosterStack, {
                                          ...
                                          onClose: _cache[34] || (_cache[34] = ($event) => closeHistorySnapshot()),
                                          onSelect: toggleHistorySelection
                                        }, null, 8, ["group-key", "title", "items", "phase", "selected-keys", "stack-limit", "mode", "disabled", "onToggle"])
                                      ], 10, _hoisted_69);
                                    }), 128))
                                  ], 2)) : (_openBlock(), _createElementBlock("div", _hoisted_72, [..._cache[82] || (_cache[82] = [
            ...
            _createVNode(_component_v_card, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_card_text, { class: "mcr-donation-card__body" }, {
                  default: _withCtx(() => [
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_73, [
                      _createElementVNode("div", {
                        ...
                        donationAvatarImage.value ? (_openBlock(), _createElementBlock("img", {
                          ...
                          src: donationAvatarImage.value,
                          alt: ""
                        }, null, 8, _hoisted_74)) : (_openBlock(), _createBlock(_component_v_icon, {
                          key: 1,
                          icon: donationAvatarIcon.value,
                          size: "38"
                        }, null, 8, ["icon"])),
                      ...
                      _createElementVNode("h3", _hoisted_76, _toDisplayString(donationView.value === "support" ? "感谢您的支持" : "呀哈哈封面工坊"), 1),
                      _createElementVNode("div", _hoisted_77, _toDisplayString(donationView.value === "support" ? "Heartfelt giving" : "使用数据统计"), 1)
                    ])) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                    ...
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_79, [
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_92, [
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("p", _hoisted_94, " 您的慷慨支持是我持续创作的动力。 ")) : _createCommentVNode("", true),
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_96, "HEARTFELT GIVING • LUMINOUS CHARITY")) : _createCommentVNode("", true)
                  ]),
                  _: 1
                })
              ]),
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-403919c0"]]);
