import { importShared } from './__federation_fn_import-ui-rev-20260718-04.js';
import { _ as _export_sfc } from './_plugin-vue_export-helper-ui-rev-20260718-04.js';
import { c as getTemplateFontFaceName, B as BUILTIN_FONT_ITEMS, M as MCR_CONTROL_DEFAULTS, a as BlueprintField, b as BlueprintSelect, A as AsyncStatusDots, V as ViewportSaveToast, l as loadPreviewFontFaces } from './ViewportSaveToast-ui-rev-20260718-04.js';

const UI_REV = "20260718-04";
const PROGRAM_VERSION = "2.2.7";
...
const _hoisted_70 = ["data-mcr-theme"];
const _hoisted_71 = { class: "yh-compact-config-header__actions" };
const _hoisted_72 = ["title", "aria-label", "disabled"];
const _hoisted_73 = { class: "yh-run-content" };
          ...
          _createVNode(_Transition, { name: "yh-compact-header" }, {
            default: _withCtx(() => [
              configCompactHeaderVisible.value ? (_openBlock(), _createElementBlock("div", {
                ...
                _cache[71] || (_cache[71] = _createElementVNode("span", { class: "yh-compact-config-header__title" }, "配置", -1)),
                _createElementVNode("div", _hoisted_71, [
                  _createElementVNode("button", {
                    type: "button",
                    class: _normalizeClass(["yh-compact-config-run", { "is-running": isGenerating.value }]),
                    style: _normalizeStyle(configRunButtonProgressStyle.value),
                    title: isGenerating.value ? configGenerationProgressLabel.value : "立即生成",
                    "aria-label": isGenerating.value ? configGenerationProgressLabel.value : "立即生成",
                    disabled: generatingNow.value,
                    ...
                    _createElementVNode("span", _hoisted_73, [
                      ...
                      isGenerating.value ? (_openBlock(), _createElementBlock("span", _hoisted_74, _toDisplayString(configGenerationProgressCount.value), 1)) : _createCommentVNode("", true)
                    ])
                  ], 14, _hoisted_72),
                  _createElementVNode("button", {
                    type: "button",
                    class: "yh-compact-config-icon",
                    title: "保存配置",
                    "aria-label": "保存配置",
                    disabled: isGenerating.value || generatingNow.value || configSaving.value,
              ...
              ], 12, _hoisted_70)) : _createCommentVNode("", true)
            ]),
            _: 1
          })
        ]))
...
const Config = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ef67d404"]]);
