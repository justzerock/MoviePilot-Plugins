import { importShared } from './__federation_fn_import-ui-rev-20260715-04.js';
import { _ as _export_sfc } from './_plugin-vue_export-helper-ui-rev-20260715-04.js';
import { B as BUILTIN_FONT_ITEMS, M as MCR_CONTROL_DEFAULTS, b as BlueprintField, d as BlueprintSelect, A as AsyncStatusDots, V as ViewportSaveToast, e as getTemplateFontFaceName } from './ViewportSaveToast-ui-rev-20260715-04.js';

const UI_REV = "20260715-04";
const PROGRAM_VERSION = "2.0.19";
...
const _sfc_main$1 = /* @__PURE__ */ _defineComponent$1({
  ...
  setup(__props) {
    ...
    function updatePosition() {
      ...
      const desired = rect ? rect.left - navWidth - 18 : viewportPadding;
      navLeft.value = Math.round(clamp(desired, viewportPadding, Math.max(viewportPadding, window.innerWidth - navWidth - viewportPadding)));
    }
    function isAtBottom() {
      return scrollRoot ? scrollRoot.scrollTop + scrollRoot.clientHeight >= scrollRoot.scrollHeight - 2 : window.scrollY + window.innerHeight >= document.documentElement.scrollHeight - 2;
    }
    function releaseProgrammaticScroll() {
      if (!targetId) return;
      const target = document.getElementById(targetId);
      const nearTarget = Boolean(target && Math.abs(target.getBoundingClientRect().top - props.topOffset) < 4);
      if (nearTarget || performance.now() >= releaseDeadline) {
        targetId = "";
        releaseFrame = 0;
        return;
      }
      releaseFrame = requestAnimationFrame(releaseProgrammaticScroll);
    }
    ...
    function setupObserver() {
      ...
      observer = new IntersectionObserver((entries) => {
        if (targetId) return;
        if (isAtBottom() && props.sections.length) {
      ...
      }, { root: scrollRoot, rootMargin: `-${props.topOffset}px 0px -62% 0px`, threshold: [0, 0.05, 0.25, 0.6] });
    ...
    function scrollToSection(id) {
      ...
      activeId.value = id;
      targetId = id;
      releaseDeadline = performance.now() + 1400;
      if (scrollRoot) {
        const rootRect = scrollRoot.getBoundingClientRect();
        const targetTop = scrollRoot.scrollTop + target.getBoundingClientRect().top - rootRect.top - props.topOffset;
        const maxTop = Math.max(0, scrollRoot.scrollHeight - scrollRoot.clientHeight);
        scrollRoot.scrollTo({ top: clamp(targetTop, 0, maxTop), behavior: "smooth" });
      } else {
        const targetTop = target.getBoundingClientRect().top + window.scrollY - props.topOffset;
        const maxTop = Math.max(0, document.documentElement.scrollHeight - window.innerHeight);
        window.scrollTo({ top: clamp(targetTop, 0, maxTop), behavior: "smooth" });
      }
      releaseFrame = requestAnimationFrame(releaseProgrammaticScroll);
    }
...
const SettingsAnchorNav = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-67b239a9"]]);
...
const _hoisted_23 = { class: "mcr-config-section-card__header" };
const _hoisted_24 = {
  id: "settings-images",
  class: "mcr-config-section-card"
};
...
const _hoisted_62 = { class: "mcr-title-config-heading" };
const _hoisted_63 = { class: "mcr-title-config-toolbar" };
const _hoisted_64 = { class: "mcr-title-config-mode" };
const _hoisted_65 = { class: "mcr-title-config-editor-shell" };
const _hoisted_66 = { class: "yh-ui-rev" };
...
`;
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", {
        ...
        _cache[66] || (_cache[66] = _createElementVNode("div", { class: "mcr-shell__aurora" }, null, -1)),
        _cache[67] || (_cache[67] = _createElementVNode("div", { class: "mcr-shell__noise" }, null, -1)),
              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_2, [
                  _createElementVNode("header", _hoisted_3, [
                    _cache[33] || (_cache[33] = _createElementVNode("div", { class: "mcr-config-brand" }, [
                    ...
                    _createElementVNode("div", _hoisted_4, [
                      ...
                      _createElementVNode("div", _hoisted_10, [
                        _createElementVNode("span", _hoisted_11, [
                          _cache[31] || (_cache[31] = _createElementVNode("span", null, "状态", -1)),
                          _createElementVNode("strong", null, _toDisplayString(config.value.enabled ? "启用" : "停用"), 1)
                        ]),
                        _createElementVNode("span", _hoisted_12, [
                          _cache[32] || (_cache[32] = _createElementVNode("span", null, "调度", -1)),
                  ...
                  _createElementVNode("div", _hoisted_15, [
                    _createElementVNode("aside", _hoisted_16, [
                      _cache[34] || (_cache[34] = _createElementVNode("div", { class: "mcr-config-sidebar__label" }, "Sections", -1)),
                      (_openBlock(), _createElementBlock(_Fragment, null, _renderList(tabItems, (item) => {
                        return _createElementVNode("button", {
                          key: item.value,
                          type: "button",
                      ...
                      _cache[35] || (_cache[35] = _createElementVNode("div", { class: "mcr-config-sidebar__spacer" }, null, -1))
                    ]),
                    _createElementVNode("main", {
                      ...
                      _createVNode(_component_v_window, {
                        ...
                        "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => tab.value = $event)
                      }, {
                        default: _withCtx(() => [
                              ...
                              _createVNode(_component_v_card_text, { class: "mcr-panel__body mcr-config-tabbody mcr-config-section-stack" }, {
                                default: _withCtx(() => [
                                  ...
                                  _createElementVNode("section", _hoisted_20, [
                                    ...
                                    _cache[38] || (_cache[38] = _createElementVNode("p", { class: "yh-field-hint yh-monitor-hint" }, [
                                  ...
                                  _createElementVNode("section", _hoisted_22, [
                                    _createElementVNode("header", _hoisted_23, [
                                      _cache[41] || (_cache[41] = _createElementVNode("div", null, [
                                        _createElementVNode("div", { class: "mcr-config-section-card__title" }, "媒体库方案"),
                                  ...
                                  _createElementVNode("section", _hoisted_25, [
                                    _cache[43] || (_cache[43] = _createElementVNode("header", { class: "mcr-config-section-card__header" }, [
                                      _createElementVNode("div", null, [
                                  ...
                                  _createElementVNode("section", _hoisted_26, [
                                    ...
                                    _createVNode(_component_v_row, { class: "mcr-form-grid mt-1" }, {
                                      default: _withCtx(() => [
                                        _createVNode(_component_v_col, {
                                          cols: "12",
                                          md: "6",
                                          ...
                                          default: _withCtx(() => [
                                            ...
                                            _cache[44] || (_cache[44] = _createElementVNode("p", null, "在预览页和画布编辑器中加载实际字体，使预览更接近正式生成。", -1))
                                          ]),
                                          _: 1
                                        }),
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            ...
                                            _cache[45] || (_cache[45] = _createElementVNode("p", null, "只保留预览中可能使用的文字，不影响正式生成使用的原始字体。", -1))
                                          ]),
                                          _: 1
                                        })
                                      ]),
                                    ...
                                    _createElementVNode("div", _hoisted_27, [
                                      ...
                                      _createElementVNode("div", _hoisted_29, [
                                        _createElementVNode("label", _hoisted_30, [
                                          _cache[48] || (_cache[48] = _createElementVNode("span", { class: "mcr-blueprint-field__label" }, "网络字体链接", -1)),
                                          _createElementVNode("span", _hoisted_31, [
                                            _withDirectives(_createElementVNode("input", {
                                              "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => fontUrlInput.value = $event),
                                          ...
                                          _cache[49] || (_cache[49] = _createElementVNode("span", { class: "mcr-blueprint-field__hint" }, "支持 ttf / ttc / otf / woff / woff2，导入后保存到插件数据目录", -1))
                                        ])
                                      ]),
                                      _createElementVNode("div", _hoisted_33, [
                                        _createElementVNode("button", {
                                          ...
                                          onClick: _cache[20] || (_cache[20] = ($event) => fontLibraryExpanded.value = !fontLibraryExpanded.value)
                                        }, [
                                          _createVNode(_component_v_icon, {
                                    ...
                                    _createElementVNode("div", _hoisted_43, [
                                      _createElementVNode("div", null, [
                                        _createVNode(BlueprintField, {
                                          ...
                                          "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => config.value.backup_path = $event),
                                          label: "备份本地路径",
                                      ...
                                      _createElementVNode("div", null, [
                                        _createVNode(BlueprintField, {
                                          ...
                                          "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => config.value.backup_cron = $event),
                                          label: "备份 cron",
                                          placeholder: "0 4 * * *",
                                      ...
                                      _createElementVNode("div", _hoisted_44, [
                                        _createElementVNode("div", _hoisted_45, [
                                          ...
                                          _createElementVNode("button", {
                                            type: "button",
                                            class: "mcr-config-collapse-button",
                                            onClick: _cache[23] || (_cache[23] = ($event) => backupLibraryExpanded.value = !backupLibraryExpanded.value)
                                          }, [
                                            _createVNode(_component_v_icon, {
                                  ...
                                  _createElementVNode("section", _hoisted_58, [
                                    _cache[59] || (_cache[59] = _createElementVNode("header", { class: "mcr-config-section-card__header" }, [
                                      _createElementVNode("div", null, [
                          ...
                          _createVNode(_component_v_window_item, { value: "title-tab" }, {
                            default: _withCtx(() => [
                              _createVNode(_component_v_card_text, { class: "mcr-panel__body mcr-config-tabbody" }, {
                                default: _withCtx(() => [
                                  _cache[64] || (_cache[64] = _createElementVNode("div", { class: "mcr-panel__eyebrow" }, "Titles", -1)),
                                  _createElementVNode("div", _hoisted_62, [
                                    _cache[61] || (_cache[61] = _createElementVNode("div", { class: "mcr-panel__title" }, "主副标题配置", -1)),
                                    _createVNode(_component_v_btn, {
                                      size: "small",
                                  ...
                                  _cache[65] || (_cache[65] = _createElementVNode("p", { class: "mcr-panel__copy mcr-config-copy" }, " 严格模式按标准 YAML 校验；宽容模式会兼容中文冒号、冒号后无空格和部分缩进问题。 ", -1)),
                                  _createElementVNode("div", _hoisted_63, [
                                    _createVNode(_component_v_switch, {
                                      modelValue: config.value.distinguish_same_name_libraries,
                                      "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => config.value.distinguish_same_name_libraries = $event),
                                      color: "primary",
                                      "hide-details": "",
                                      density: "comfortable",
                                      label: "区分同名媒体库"
                                    }, null, 8, ["modelValue"]),
                                    _cache[62] || (_cache[62] = _createElementVNode("span", { class: "mcr-title-config-mode" }, " 开启后自动补全使用「服务器名_媒体库名」；仅使用媒体库名时，同名库共用同一配置 ", -1)),
                                    _createVNode(_component_v_switch, {
                                      modelValue: config.value.title_config_strict,
                                      "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => config.value.title_config_strict = $event),
                                      color: "primary",
                                      "hide-details": "",
                                      density: "comfortable",
                                      label: config.value.title_config_strict ? "严格模式" : "宽容模式"
                                    }, null, 8, ["modelValue", "label"]),
                                    _createElementVNode("span", _hoisted_64, _toDisplayString(config.value.title_config_strict ? "必须使用标准 YAML 语法" : "允许常见中文符号和空格容错"), 1)
                                  ]),
                                  _createElementVNode("div", _hoisted_65, [
                                    _createVNode(BlueprintField, {
                                      modelValue: titleConfigEditorText.value,
                                      "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => titleConfigEditorText.value = $event),
                                      textarea: "",
                                      label: "主副标题配置 (YAML)",
                                      rows: "16",
                                      spellcheck: "false",
                                      ...
                                      onFocus: _cache[27] || (_cache[27] = ($event) => titleConfigEditorFocused.value = true),
                                      onBlur: _cache[28] || (_cache[28] = ($event) => titleConfigEditorFocused.value = false),
                                  ...
                                  _createElementVNode("div", { class: "mcr-title-config-reference" }, [
                                    _cache[63] || (_cache[63] = _createElementVNode("div", { class: "mcr-title-config-reference__label" }, "格式参考", -1)),
                      ...
                      _createElementVNode("div", _hoisted_66, "前端 UI " + _toDisplayString(_unref(UI_REV)) + " · 主程序 v" + _toDisplayString(_unref(PROGRAM_VERSION)), 1)
                    ], 512)
                  ])
                ]),
...
const Config = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-945ff153"]]);
