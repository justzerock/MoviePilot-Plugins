import { importShared } from './__federation_fn_import-ui-rev-20260716-06.js';
import { _ as _export_sfc } from './_plugin-vue_export-helper-ui-rev-20260716-06.js';
import { g as getTemplateFontFamilyStack, c as clearPreviewFontFamily, a as applyPreviewFontFamily, S as SEMANTIC_FONT_ITEMS, B as BUILTIN_FONT_ITEMS, b as BlueprintField, d as BlueprintSelect, M as MCR_CONTROL_DEFAULTS, A as AsyncStatusDots, V as ViewportSaveToast } from './ViewportSaveToast-ui-rev-20260716-06.js';

const {defineComponent:_defineComponent$5} = await importShared('vue');

const {normalizeStyle:_normalizeStyle$4,createElementVNode:_createElementVNode$4,toDisplayString:_toDisplayString$4,openBlock:_openBlock$5,createElementBlock:_createElementBlock$5} = await importShared('vue');

const _hoisted_1$5 = { class: "blueprint-range" };
const _hoisted_2$4 = ["min", "max", "step", "value"];
const _hoisted_3$4 = { class: "blueprint-range__content" };
const _hoisted_4$4 = { class: "blueprint-range__label" };
const _hoisted_5$4 = ["min", "max", "step", "value"];
...
const _sfc_main$5 = /* @__PURE__ */ _defineComponent$5({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$5(), _createElementBlock$5("label", _hoisted_1$5, [
        _createElementVNode$4("input", {
          ...
          style: _normalizeStyle$4(rangeStyle.value),
        ...
        _createElementVNode$4("span", _hoisted_3$4, [
          _createElementVNode$4("span", _hoisted_4$4, _toDisplayString$4(__props.label), 1),
          _createElementVNode$4("input", {
...
const BlueprintRange = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-fa32df23"]]);
...
const {normalizeClass:_normalizeClass$4,openBlock:_openBlock$4,createElementBlock:_createElementBlock$4} = await importShared('vue');
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$4(), _createElementBlock$4("div", {
        class: _normalizeClass$4(["mcr-svg-template-preview", {
...
const SvgTemplatePreview = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-119d6e09"]]);
 ...
 * @license MIT
 */
const {hasInjectionContext,inject,toRaw,watch: watch$4,unref,markRaw,effectScope,ref: ref$4,isRef,isReactive,getCurrentScope,onScopeDispose,getCurrentInstance,reactive: reactive$1,toRef,nextTick: nextTick$4,computed: computed$3,toRefs} = await importShared('vue');
let activePinia;
...
function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
  ...
  const partialStore = {
    ...
    $subscribe(callback, options2 = {}) {
      ...
      const stopWatcher = scope.run(() => watch$4(() => pinia.state.value[$id], (state) => {
...
const {createTextVNode:_createTextVNode$1,resolveComponent:_resolveComponent$2,withCtx:_withCtx$1,createVNode:_createVNode$2,createElementVNode:_createElementVNode$3,openBlock:_openBlock$3,createElementBlock:_createElementBlock$3,createCommentVNode:_createCommentVNode$3,renderList:_renderList$3,Fragment:_Fragment$3,createBlock:_createBlock$2,toDisplayString:_toDisplayString$3,withModifiers:_withModifiers$2,withKeys:_withKeys$2,normalizeClass:_normalizeClass$3,normalizeStyle:_normalizeStyle$3,renderSlot:_renderSlot,Teleport:_Teleport$1,unref:_unref$1} = await importShared('vue');

const _hoisted_1$3 = ["data-loading"];
const _hoisted_2$3 = { class: "mcr-sticker-library__header" };
const _hoisted_3$3 = { class: "mcr-sticker-library__actions" };
const _hoisted_4$3 = {
  key: 0,
...
const _hoisted_7$3 = ["title", "onClick", "onKeydown"];
const _hoisted_8$3 = { class: "mcr-sticker-item__thumb" };
const _hoisted_9$3 = ["src", "alt"];
const _hoisted_10$3 = { class: "mcr-sticker-item__name" };
const _hoisted_11$3 = ["title", "onClick", "onKeydown"];
const _hoisted_12$3 = { class: "mcr-layout-stage-wrap" };
const _hoisted_13$3 = {
  key: 0,
...
const {computed: computed$2,nextTick: nextTick$3,onMounted: onMounted$2,onUnmounted: onUnmounted$1,ref: ref$3,watch: watch$3} = await importShared('vue');
...
const _sfc_main$3 = /* @__PURE__ */ _defineComponent$3({
  ...
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit = __emit;
    const lockAspectRatio = ref$3(false);
    const cropModeEnabled = ref$3(false);
    const floatingLayerListCollapsed = ref$3(true);
    const floatingLayerListPosition = ref$3({ x: FLOATING_LAYER_MARGIN, y: 120 });
    const layerListButtonWrapEl = ref$3(null);
    const floatingLayerListEl = ref$3(null);
    const inlineTextEditor = ref$3({
      visible: false,
      layerId: "",
      value: "",
      x: 0,
    ...
    const internalLayout = ref$3(cloneLayout(props.modelValue));
    ...
    const polygonSnapGuide = ref$3({ x: null, y: null });
    ...
    const editorRootEl = ref$3(null);
    const canvasEl = ref$3(null);
    const canvasPaneEl = ref$3(null);
    const layerActionsEl = ref$3(null);
    const sidePaneEl = ref$3(null);
    const stickerFileInputEl = ref$3(null);
    const canvasScale = ref$3(1);
    const canvasPaneDisplayHeight = ref$3(0);
    const imageRegistry = ref$3({});
    const stickerLibraryOpen = ref$3(false);
    const stickerLibraryLoading = ref$3(false);
    const stickerLibraryItems = ref$3([]);
    const transformerRef = ref$3(null);
    ...
    const activeSnapGuides = ref$3({ vertical: [], horizontal: [] });
    ...
    const dragState = ref$3(null);
    const polygonPointDrag = ref$3(null);
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock$3(), _createBlock$2(_component_v_card, {
        variant: "outlined",
        class: _normalizeClass$3(["mcr-layout-editor", { "mcr-layout-editor--embedded": __props.embedded }]),
        ...
        default: _withCtx$1(() => [
          _createElementVNode$3("div", {
            ...
            _createElementVNode$3("div", {
              ...
              stickerLibraryOpen.value ? (_openBlock$3(), _createElementBlock$3("div", {
                key: 0,
                class: "mcr-sticker-library",
                "data-loading": stickerLibraryLoading.value ? "true" : "false"
              }, [
                _createElementVNode$3("div", _hoisted_2$3, [
                  _cache[55] || (_cache[55] = _createElementVNode$3("div", null, [
                    _createElementVNode$3("div", { class: "mcr-sticker-library__title" }, "贴图库"),
                    _createElementVNode$3("div", { class: "mcr-sticker-library__hint" }, "选择已上传贴图，或上传新的本地图片。")
                  ], -1)),
                ...
                stickerLibraryLoading.value ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_4$3, " 加载贴图库... ")) : !stickerLibraryItems.value.length ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_5$3, " 暂无贴图 ")) : (_openBlock$3(), _createElementBlock$3("div", _hoisted_6$3, [
                  (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(stickerLibraryItems.value, (item) => {
                    return _openBlock$3(), _createElementBlock$3("div", {
                      ...
                      onKeydown: [
                        _withKeys$2(_withModifiers$2(($event) => addStickerFromLibrary(item), ["prevent"]), ["enter"]),
                        _withKeys$2(_withModifiers$2(($event) => addStickerFromLibrary(item), ["prevent"]), ["space"])
                      ]
                    }, [
                      _createElementVNode$3("span", _hoisted_8$3, [
                        item.dataUrl || item.url ? (_openBlock$3(), _createElementBlock$3("img", {
                          key: 0,
                          src: item.dataUrl || item.url,
                          alt: item.name
                        }, null, 8, _hoisted_9$3)) : (_openBlock$3(), _createBlock$2(_component_v_icon, {
                          key: 1,
                          icon: "mdi-sticker-outline",
                          size: "24"
                        }))
                      ]),
                      _createElementVNode$3("span", _hoisted_10$3, _toDisplayString$3(item.name), 1),
                      _createElementVNode$3("button", {
                        type: "button",
                        class: _normalizeClass$3(["mcr-sticker-item__delete", { "mcr-sticker-item__delete--active": isStickerInUse(item) }]),
                        title: isStickerInUse(item) ? "删除贴图并移除当前方案中的引用" : "删除贴图",
                        onClick: _withModifiers$2(($event) => deleteStickerItem(item), ["stop", "prevent"]),
                        onKeydown: [
                          _withKeys$2(_withModifiers$2(($event) => deleteStickerItem(item), ["stop", "prevent"]), ["enter"]),
                          _withKeys$2(_withModifiers$2(($event) => deleteStickerItem(item), ["stop", "prevent"]), ["space"])
                        ]
                      }, [
              ...
              ], 8, _hoisted_1$3)) : _createCommentVNode$3("", true),
              _createElementVNode$3("div", _hoisted_12$3, [
                _createElementVNode$3("div", {
                  ...
                  _createVNode$2(SvgTemplatePreview, {
                  ...
                  activeSnapGuideStyles.value.vertical.length || activeSnapGuideStyles.value.horizontal.length ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_13$3, [
                    (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(activeSnapGuideStyles.value.vertical, (guide) => {
                      return _openBlock$3(), _createElementBlock$3("span", {
                        key: `v-${guide.value}`,
                        class: "mcr-snap-guide mcr-snap-guide--vertical",
                        style: _normalizeStyle$3({ left: guide.position })
                      }, null, 4);
                    }), 128)),
                    (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(activeSnapGuideStyles.value.horizontal, (guide) => {
                      return _openBlock$3(), _createElementBlock$3("span", {
                        key: `h-${guide.value}`,
                        class: "mcr-snap-guide mcr-snap-guide--horizontal",
                        style: _normalizeStyle$3({ top: guide.position })
                      }, null, 4);
                    }), 128))
                  ])) : _createCommentVNode$3("", true),
                  polygonOverlayPoints.value.length ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_14$3, [
                    (_openBlock$3(), _createElementBlock$3("svg", _hoisted_15$2, [
                      _createElementVNode$3("polygon", {
                        points: polygonOverlayPointString.value,
                        class: "mcr-polygon-overlay__shape"
                      }, null, 8, _hoisted_16$2),
                      polygonSnapGuide.value.x !== null ? (_openBlock$3(), _createElementBlock$3("line", {
                        key: 0,
                      ...
                      }, null, 8, _hoisted_17$2)) : _createCommentVNode$3("", true),
                      polygonSnapGuide.value.y !== null ? (_openBlock$3(), _createElementBlock$3("line", {
                        key: 1,
                        x1: "0",
                        ...
                        class: "mcr-polygon-overlay__guide"
                      }, null, 8, _hoisted_18$2)) : _createCommentVNode$3("", true)
                    ])),
                    (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(polygonOverlayPoints.value, (point) => {
                      return _openBlock$3(), _createElementBlock$3("button", {
                        key: point.index,
                        type: "button",
                        class: "mcr-polygon-anchor",
                        style: _normalizeStyle$3({ left: `${point.x}px`, top: `${point.y}px` }),
                        onPointerdown: _withModifiers$2(($event) => startPolygonPointDrag(point.index, $event), ["stop", "prevent"]),
                        onDblclick: _withModifiers$2(($event) => removePolygonPoint(point.index), ["stop", "prevent"])
                      }, [
                        _createElementVNode$3("span", null, _toDisplayString$3(point.index + 1), 1)
                      ], 44, _hoisted_19$2);
                    }), 128))
                  ])) : _createCommentVNode$3("", true),
                  inlineTextEditor.value.visible ? (_openBlock$3(), _createElementBlock$3("div", {
                    key: 2,
                    class: "mcr-inline-editor",
                    style: _normalizeStyle$3(inlineEditorStyle.value)
                  }, [
                    _createVNode$2(BlueprintField, {
                      ...
                      onKeydown: [
                        _withKeys$2(_withModifiers$2(commitInlineTextEdit, ["prevent"]), ["enter"]),
                        _withKeys$2(_withModifiers$2(cancelInlineTextEdit, ["prevent"]), ["esc"])
                      ]
                  ...
                  ], 4)) : _createCommentVNode$3("", true)
                ], 512),
                _cache[58] || (_cache[58] = _createElementVNode$3("div", { class: "mcr-layout-editor-note mt-2" }, " SVG 画布按比例缩放显示，保存时仍使用真实像素坐标。 ", -1)),
            ...
            props.floatingToolsVisible && !floatingLayerListCollapsed.value ? (_openBlock$3(), _createBlock$2(_Teleport$1, {
              key: 0,
              to: "body"
            }, [
              _createElementVNode$3("div", {
                ...
                "data-mcr-theme": props.theme,
                style: _normalizeStyle$3(floatingLayerListStyle.value)
              }, [
                _createElementVNode$3("div", _hoisted_23$2, [
                  _createElementVNode$3("button", {
                    type: "button",
                    class: _normalizeClass$3(["mcr-layer-list__option", { "mcr-layer-list__option--active": editingBackground.value }]),
                    onPointerdown: _cache[2] || (_cache[2] = _withModifiers$2(() => {
                    }, ["prevent"])),
                    ...
                    _cache[59] || (_cache[59] = _createElementVNode$3("span", { class: "mcr-layer-list__content" }, [
                      _createElementVNode$3("span", { class: "mcr-layer-list__name" }, "背景")
                    ], -1))
                  ], 34),
                  (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(editableLayerList.value, (layer) => {
                    return _openBlock$3(), _createElementBlock$3("button", {
                      key: layer.id,
                      type: "button",
                      class: _normalizeClass$3(["mcr-layer-list__option", { "mcr-layer-list__option--active": layer.id === selectedLayerId.value }]),
                      onPointerdown: _cache[4] || (_cache[4] = _withModifiers$2(() => {
                      }, ["prevent"])),
                      ...
                      _createElementVNode$3("span", _hoisted_25$2, [
                        _createElementVNode$3("span", _hoisted_26$2, _toDisplayString$3(layerLabel(layer)), 1)
                      ]),
                      _createElementVNode$3("span", {
                        ...
                        onPointerdown: _cache[3] || (_cache[3] = _withModifiers$2(() => {
                        }, ["stop", "prevent"])),
                        onClick: _withModifiers$2(($event) => removeLayerFromLayerList(layer.id), ["stop", "prevent"])
                      }, [
                        _createVNode$2(_component_v_icon, {
                          icon: "mdi-trash-can-outline",
                          size: "15"
            ...
            _createElementVNode$3("aside", {
              ref_key: "sidePaneEl",
              ref: sidePaneEl,
              class: "mcr-layout-side-pane",
              style: _normalizeStyle$3(layoutSidePaneStyle.value)
            }, [
              props.floatingToolsVisible ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_28$2, [
                _createElementVNode$3("span", {
                  ...
                  _createVNode$2(_component_v_btn, {
                    ...
                    onClick: _withModifiers$2(toggleFloatingLayerList, ["stop"])
                  }, {
                    default: _withCtx$1(() => [
                      _createElementVNode$3("span", _hoisted_29$2, _toDisplayString$3(currentLayerButtonLabel.value), 1),
                      _createVNode$2(_component_v_icon, {
              ...
              editingBackground.value ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_30$2, [
                _createVNode$2(BlueprintSelect, {
                ...
                _createVNode$2(_component_v_row, {
                  ...
                  default: _withCtx$1(() => [
                    ...
                    (layout.value.background?.colorSource || "auto") === "custom" ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 0,
                      cols: "6"
                    }, {
                      default: _withCtx$1(() => [
                    ...
                    layout.value.background?.type === "gradient" ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 1,
                      cols: "6"
                    }, {
                      default: _withCtx$1(() => [
                ...
                (layout.value.background?.type || "blurred-image-color") !== "transparent" ? (_openBlock$3(), _createBlock$2(BlueprintRange, {
                  key: 0,
                ...
                }, null, 8, ["model-value"])) : _createCommentVNode$3("", true),
                _createVNode$2(BlueprintRange, {
                ...
                (layout.value.background?.type || "blurred-image-color") === "blurred-image-color" ? (_openBlock$3(), _createBlock$2(BlueprintRange, {
                  key: 1,
                ...
                layout.value.background?.maskPolygon ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_31$2, [
                  _createVNode$2(_component_v_btn, {
                    size: "small",
                    class: "mcr-button mcr-button--ghost",
              ...
              selectedLayer.value ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_32$2, [
                ...
                _createVNode$2(_component_v_row, {
                  ...
                  default: _withCtx$1(() => [
                    _unref$1(isImageLayer)(selectedLayer.value) && selectedLayer.value.assetKind !== "sticker" ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 0,
                      cols: "12"
                    }, {
                      default: _withCtx$1(() => [
                    ...
                    _unref$1(isImageLayer)(selectedLayer.value) ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 1,
                      cols: "12"
                    }, {
                      default: _withCtx$1(() => [
                ...
                _unref$1(isImageLayer)(selectedLayer.value) ? (_openBlock$3(), _createBlock$2(_component_v_row, {
                  key: 0,
                  dense: "",
                  class: "mt-1"
                }, {
                ...
                _unref$1(isImageLayer)(selectedLayer.value) ? (_openBlock$3(), _createBlock$2(_component_v_row, {
                  ...
                  default: _withCtx$1(() => [
                    ...
                    (selectedLayer.value.colorSource || "none") === "custom" ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 0,
                      cols: "6"
                    }, {
                      default: _withCtx$1(() => [
                    ...
                    (selectedLayer.value.colorSource || "none") !== "none" ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 1,
                      cols: "12"
                    }, {
                      default: _withCtx$1(() => [
                    ...
                    selectedLayer.value.maskPolygon ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 2,
                      cols: "12",
                      class: "mcr-polygon-actions"
                    }, {
                ...
                _createVNode$2(_component_v_row, {
                  ...
                  default: _withCtx$1(() => [
                    _unref$1(isCustomTextLayer)(selectedLayer.value) ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 0,
                      cols: "12"
                    }, {
                      default: _withCtx$1(() => [
                    ...
                    _unref$1(isCustomTextLayer)(selectedLayer.value) && (selectedLayer.value.contentSource || "fixed") === "library" ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 1,
                      cols: "12"
                    }, {
                      default: _withCtx$1(() => [
                ...
                _createVNode$2(_component_v_row, {
                  ...
                  default: _withCtx$1(() => [
                    _unref$1(isTextLayer)(selectedLayer.value) ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 0,
                      cols: "12"
                    }, {
                      default: _withCtx$1(() => [
                ...
                _unref$1(isTextLayer)(selectedLayer.value) ? (_openBlock$3(), _createBlock$2(_component_v_row, {
                  key: 2,
                  dense: "",
                  class: "mt-1"
                }, {
                  default: _withCtx$1(() => [
                    _createVNode$2(_component_v_col, { cols: "12" }, {
                      default: _withCtx$1(() => [
                        _createElementVNode$3("div", _hoisted_33$2, [
                          (_openBlock$3(), _createElementBlock$3(_Fragment$3, null, _renderList$3(textAlignItems, (item) => {
                            return _createElementVNode$3("button", {
                              key: item.value,
                              type: "button",
                              class: _normalizeClass$3(["mcr-text-align-button", { "mcr-text-align-button--active": (selectedLayer.value.textAlign || "center") === item.value }]),
                              title: item.title,
                    ...
                    (selectedLayer.value.colorSource || "custom") === "custom" ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 0,
                      cols: "12"
                    }, {
                      default: _withCtx$1(() => [
                ...
                _createVNode$2(_component_v_row, {
                  ...
                  default: _withCtx$1(() => [
                    ...
                    lockAspectRatio.value ? (_openBlock$3(), _createBlock$2(_component_v_col, {
                      key: 0,
                      cols: "12"
                    }, {
                      default: _withCtx$1(() => [
                        _createElementVNode$3("div", _hoisted_35$1, [
                          (_openBlock$3(), _createElementBlock$3(_Fragment$3, null, _renderList$3(aspectRatioPresets, (preset) => {
                            return _createElementVNode$3("button", {
                              key: preset.label,
                              type: "button",
                              class: "mcr-aspect-preset",
                              onPointerdown: _cache[35] || (_cache[35] = _withModifiers$2(() => {
                              }, ["prevent"])),
                              onClick: ($event) => applySelectedAspectRatio(preset.ratio)
                            }, _toDisplayString$3(preset.label), 41, _hoisted_36$1);
                          }), 64))
                        ])
                      ]),
                      _: 1
...
const CustomLayoutEditor = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-3e9722ee"]]);

const {defineComponent:_defineComponent$2} = await importShared('vue');

const {createElementVNode:_createElementVNode$2,openBlock:_openBlock$2,createElementBlock:_createElementBlock$2,createCommentVNode:_createCommentVNode$2,createBlock:_createBlock$1,normalizeStyle:_normalizeStyle$2,renderList:_renderList$2,Fragment:_Fragment$2,toDisplayString:_toDisplayString$2,normalizeClass:_normalizeClass$2} = await importShared('vue');

const _hoisted_1$2 = { class: "simulation-shell" };
const _hoisted_2$2 = {
  key: 0,
...
const _hoisted_4$2 = { class: "sim-custom-stage" };
const _hoisted_5$2 = ["src", "alt"];
const _hoisted_6$2 = {
  key: 1,
  class: "sim-grid sim-grid-style-1"
};
const _hoisted_7$2 = { class: "sim-style-1-copy" };
const _hoisted_8$2 = { class: "sim-style-1-stage" };
const _hoisted_9$2 = { class: "sim-style-1-card sim-style-1-card-front" };
const _hoisted_10$2 = ["src", "alt"];
const _hoisted_11$2 = {
  key: 0,
  class: "sim-custom-stage-shell"
};
const _hoisted_12$2 = { class: "sim-custom-stage" };
const _hoisted_13$2 = ["src", "alt"];
const _hoisted_14$2 = { class: "sim-style-2-foreground" };
...
const {computed: computed$1,nextTick: nextTick$2,onMounted: onMounted$1,onUnmounted,ref: ref$2,watch: watch$2} = await importShared('vue');
const _sfc_main$2 = /* @__PURE__ */ _defineComponent$2({
  ...
  setup(__props) {
    ...
    const previewStageEl = ref$2(null);
    const previewStageScale = ref$2(1);
    const fontRevision = ref$2(0);
    ...
    watch$2(
      ...
      () => {
        nextTick$2(() => updatePreviewStageScale());
      }
    );
    onMounted$1(() => {
      nextTick$2(() => {
    ...
    return (_ctx, _cache) => {
      return _openBlock$2(), _createElementBlock$2("div", _hoisted_1$2, [
        !__props.source || !__props.source.images.length ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_2$2, [..._cache[0] || (_cache[0] = [
          _createElementVNode$2("div", { class: "text-subtitle-2 mb-2" }, "暂无可用预览素材", -1),
          _createElementVNode$2("div", { class: "text-caption text-medium-emphasis" }, "请先配置媒体库或自定义图片目录。", -1)
        ])])) : (_openBlock$2(), _createElementBlock$2("div", {
          key: 1,
          class: "simulation-canvas",
          style: _normalizeStyle$2(canvasStyle.value)
        }, [
          _createElementVNode$2("div", {
            ref_key: "previewStageEl",
            ref: previewStageEl,
            class: _normalizeClass$2(["sim-stage-shell", { "sim-stage-shell--layout": usesEditorLayoutPreview.value }])
          }, [
            usesEditorLayoutPreview.value ? (_openBlock$2(), _createBlock$1(SvgTemplatePreview, {
              key: 0,
              ...
              "font-revision": fontRevision.value,
              "auto-blend-color": autoBlendColor.value
            }, null, 8, ["template", "source", "params", "font-revision", "auto-blend-color"])) : (_openBlock$2(), _createElementBlock$2("div", {
              key: 1,
              class: "sim-stage",
              style: _normalizeStyle$2(previewStageFixedStyle.value)
            }, [
              styleBase.value === "static_1" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 0 }, [
                _createElementVNode$2("div", {
                  class: "sim-bg",
                  style: _normalizeStyle$2(backgroundStyle.value)
                }, null, 4),
                _createElementVNode$2("div", {
                  class: "sim-overlay",
                  style: _normalizeStyle$2(overlayStyle.value)
                }, null, 4),
                shouldUseLayoutDrivenPresetStage.value ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_3$2, [
                  _createElementVNode$2("div", _hoisted_4$2, [
                    (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(sortedLayers.value, (layer) => {
                      return _openBlock$2(), _createElementBlock$2("div", {
                        key: layer.id,
                        class: "sim-custom-layer",
                        style: _normalizeStyle$2(getLayerStyle(layer))
                      }, [
                        layer.type === "image" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 0 }, [
                          getLayerPreviewImage(layer)?.src ? (_openBlock$2(), _createElementBlock$2("img", {
                            key: 0,
                            class: "sim-custom-image",
                            src: getLayerPreviewImage(layer)?.src,
                            alt: getLayerPreviewImage(layer)?.label || `image-${layer.sourceIndex}`,
                            style: _normalizeStyle$2(getImageStyle(layer))
                          }, null, 12, _hoisted_5$2)) : _createCommentVNode$2("", true)
                        ], 64)) : layer.type === "main_title" || layer.type === "title_zh" ? (_openBlock$2(), _createElementBlock$2("div", {
                          key: 1,
                          class: "sim-custom-text sim-custom-text-zh",
                          style: _normalizeStyle$2(getTitleStyle(layer))
                        }, [
                          (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(getMeasuredLayerLines(layer), (line, index) => {
                            return _openBlock$2(), _createElementBlock$2("span", {
                              key: `${layer.id}-zh-${index}`,
                              class: "sim-custom-text-line",
                              style: _normalizeStyle$2(getMeasuredLineStyle(layer, index))
                            }, _toDisplayString$2(line.text), 5);
                          }), 128))
                        ], 4)) : (_openBlock$2(), _createElementBlock$2("div", {
                          key: 2,
                  ...
                  _createElementVNode$2("div", _hoisted_7$2, [
                    _createElementVNode$2("div", {
                      class: "sim-title-zh",
                      style: _normalizeStyle$2(mainTitleStyle.value)
                    }, _toDisplayString$2(titles.value.zh || "未配置中文标题"), 5),
                    _createElementVNode$2("div", {
                      class: "sim-title-en",
                      style: _normalizeStyle$2(subtitleStyle.value)
                    }, _toDisplayString$2(titles.value.en || "UNTITLED"), 5)
                  ]),
                  _createElementVNode$2("div", _hoisted_8$2, [
                    _cache[1] || (_cache[1] = _createElementVNode$2("div", { class: "sim-style-1-card sim-style-1-card-back" }, null, -1)),
                    _cache[2] || (_cache[2] = _createElementVNode$2("div", { class: "sim-style-1-card sim-style-1-card-mid" }, null, -1)),
              ...
              ], 64)) : styleBase.value === "static_2" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 1 }, [
                _createElementVNode$2("div", {
                  class: "sim-bg",
                  style: _normalizeStyle$2(backgroundStyle.value)
                }, null, 4),
                ...
                shouldUseLayoutDrivenPresetStage.value ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_11$2, [
                      ...
                      return _openBlock$2(), _createElementBlock$2("div", {
                        ...
                        layer.type === "image" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 0 }, [
                          getLayerPreviewImage(layer)?.src ? (_openBlock$2(), _createElementBlock$2("img", {
                            ...
                            alt: getLayerPreviewImage(layer)?.label || `image-${layer.sourceIndex}`,
                            style: _normalizeStyle$2(getImageStyle(layer))
                          }, null, 12, _hoisted_13$2)) : _createCommentVNode$2("", true)
                        ], 64)) : layer.type === "main_title" || layer.type === "title_zh" ? (_openBlock$2(), _createElementBlock$2("div", {
                          key: 1,
                          class: "sim-custom-text sim-custom-text-zh",
                          style: _normalizeStyle$2(getTitleStyle(layer))
                  ...
                  _cache[3] || (_cache[3] = _createElementVNode$2("div", { class: "sim-style-2-shadow" }, null, -1)),
                ...
                !shouldUseLayoutDrivenPresetStage.value ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_16$1, [
              ...
              ], 64)) : styleBase.value === "static_3" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 2 }, [
                _createElementVNode$2("div", {
                  class: "sim-style-3-bg",
                  style: _normalizeStyle$2(style3BackgroundStyle.value)
                }, null, 4),
                shouldUseLayoutDrivenPresetStage.value ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_18$1, [
                      ...
                      return _openBlock$2(), _createElementBlock$2("div", {
                        ...
                        layer.type === "image" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 0 }, [
                          getLayerPreviewImage(layer)?.src ? (_openBlock$2(), _createElementBlock$2("img", {
                            ...
                            alt: getLayerPreviewImage(layer)?.label || `image-${layer.sourceIndex}`,
                            style: _normalizeStyle$2(getImageStyle(layer))
                          }, null, 12, _hoisted_20$1)) : _createCommentVNode$2("", true)
                        ], 64)) : layer.type === "main_title" || layer.type === "title_zh" ? (_openBlock$2(), _createElementBlock$2("div", {
                          key: 1,
                          class: "sim-custom-text sim-custom-text-zh",
                          style: _normalizeStyle$2(getTitleStyle(layer))
                  ...
                  _createElementVNode$2("div", _hoisted_21$1, [
                    ...
                    _createElementVNode$2("div", _hoisted_22$1, [
                      _createElementVNode$2("div", {
                        ...
                        style: _normalizeStyle$2(style3AccentStyle.value)
                      }, null, 4),
                      _createElementVNode$2("div", {
                        class: "sim-style-3-subtitle",
                        style: _normalizeStyle$2(subtitleStyle.value)
                      }, [
                        (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(style3SubtitleLines.value, (line, index) => {
                          return _openBlock$2(), _createElementBlock$2("span", {
                  ...
                  _createElementVNode$2("div", _hoisted_23$1, [
                    (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(style3Columns.value, (column, columnIndex) => {
                      return _openBlock$2(), _createElementBlock$2("div", {
                        key: `column-${columnIndex}`,
                        class: _normalizeClass$2(["sim-style-3-column", `sim-style-3-column-${columnIndex + 1}`])
                      }, [
                        (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(column, (image) => {
                          return _openBlock$2(), _createElementBlock$2("div", {
                            key: image.key,
              ...
              ], 64)) : styleBase.value === "static_4" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 3 }, [
                _createElementVNode$2("div", {
                  class: "sim-bg",
                  style: _normalizeStyle$2(fullBackgroundStyle.value)
                }, null, 4),
                _createElementVNode$2("div", {
                  class: "sim-overlay sim-overlay-strong",
                  style: _normalizeStyle$2(overlayStyle.value)
                }, null, 4),
                shouldUseLayoutDrivenPresetStage.value ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_25$1, [
                      ...
                      return _openBlock$2(), _createElementBlock$2("div", {
                        ...
                        layer.type === "image" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 0 }, [
                          getLayerPreviewImage(layer)?.src ? (_openBlock$2(), _createElementBlock$2("img", {
                            ...
                            alt: getLayerPreviewImage(layer)?.label || `image-${layer.sourceIndex}`,
                            style: _normalizeStyle$2(getImageStyle(layer))
                          }, null, 12, _hoisted_27$1)) : _createCommentVNode$2("", true)
                        ], 64)) : layer.type === "main_title" || layer.type === "title_zh" ? (_openBlock$2(), _createElementBlock$2("div", {
                          key: 1,
                          class: "sim-custom-text sim-custom-text-zh",
                          style: _normalizeStyle$2(getTitleStyle(layer))
                ...
                ])) : (_openBlock$2(), _createElementBlock$2("div", _hoisted_28$1, [
                  _createElementVNode$2("div", {
              ...
              ], 64)) : (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 4 }, [
                _createElementVNode$2("div", {
                  class: "sim-bg",
                  style: _normalizeStyle$2(backgroundStyle.value)
                }, null, 4),
                ...
                hasCustomLayout.value ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_29$1, [
                      ...
                      return _openBlock$2(), _createElementBlock$2("div", {
                        ...
                        layer.type === "image" ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 0 }, [
                          getLayerPreviewImage(layer)?.src ? (_openBlock$2(), _createElementBlock$2("img", {
                            ...
                            alt: getLayerPreviewImage(layer)?.label || `image-${layer.sourceIndex}`,
                            style: _normalizeStyle$2(getImageStyle(layer))
                          }, null, 12, _hoisted_31$1)) : _createCommentVNode$2("", true)
                        ], 64)) : layer.type === "main_title" || layer.type === "title_zh" ? (_openBlock$2(), _createElementBlock$2("div", {
                          key: 1,
                          class: "sim-custom-text sim-custom-text-zh",
                          style: _normalizeStyle$2(getTitleStyle(layer))
                ...
                ])) : (_openBlock$2(), _createElementBlock$2("div", _hoisted_32$1, [..._cache[4] || (_cache[4] = [
                  _createElementVNode$2("div", { class: "text-subtitle-2 mb-2" }, "当前未配置自定义布局", -1),
                  _createElementVNode$2("div", { class: "text-caption text-medium-emphasis" }, "先在“自定义风格”页保存一个方案，再回到这里预览。", -1)
                ])]))
              ], 64))
            ], 4))
          ], 2),
          variant.value === "animated" ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_33$1, [..._cache[5] || (_cache[5] = [
...
const GeneratePreviewSimulation = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-45ee8566"]]);

const {defineComponent:_defineComponent$1} = await importShared('vue');

const {toDisplayString:_toDisplayString$1,createElementVNode:_createElementVNode$1,resolveComponent:_resolveComponent$1,createVNode:_createVNode$1,withModifiers:_withModifiers$1,openBlock:_openBlock$1,createElementBlock:_createElementBlock$1,createCommentVNode:_createCommentVNode$1,renderList:_renderList$1,Fragment:_Fragment$1,normalizeClass:_normalizeClass$1,normalizeStyle:_normalizeStyle$1,withKeys:_withKeys$1} = await importShared('vue');

const _hoisted_1$1 = ["data-history-group", "aria-expanded", "onKeydown"];
const _hoisted_2$1 = { class: "yh-history-poster-stack__header" };
const _hoisted_3$1 = { class: "yh-history-poster-stack__heading" };
const _hoisted_4$1 = ["title"];
const _hoisted_5$1 = ["role", "aria-label"];
const _hoisted_6$1 = ["aria-selected", "aria-label", "disabled", "onClick"];
const _hoisted_7$1 = { class: "yh-history-poster-stack__image-shell" };
const _hoisted_8$1 = ["src", "alt", "onError"];
const _hoisted_9$1 = {
  key: 1,
...
const {nextTick: nextTick$1,ref: ref$1,watch: watch$1} = await importShared('vue');
...
const _sfc_main$1 = /* @__PURE__ */ _defineComponent$1({
  ...
  setup(__props, { emit: __emit }) {
    ...
    watch$1(
      ...
      (expanded) => {
        if (!expanded) return;
        void nextTick$1(() => rootEl.value?.focus({ preventScroll: true }));
      }
    );
    return (_ctx, _cache) => {
      ...
      return _openBlock$1(), _createElementBlock$1("article", {
        ref_key: "rootEl",
        ref: rootEl,
        class: _normalizeClass$1(["yh-history-poster-stack", [
          `is-${__props.phase}`,
        ...
        tabindex: "0",
        onKeydown: [
          _withKeys$1(_withModifiers$1(handlePrimaryAction, ["prevent"]), ["enter"]),
          _withKeys$1(_withModifiers$1(handlePrimaryAction, ["prevent"]), ["space"]),
          _cache[2] || (_cache[2] = _withKeys$1(_withModifiers$1(($event) => emit("close"), ["prevent"]), ["esc"]))
        ]
      }, [
        _createElementVNode$1("header", _hoisted_2$1, [
          _createElementVNode$1("div", _hoisted_3$1, [
            _createElementVNode$1("strong", { title: __props.title }, _toDisplayString$1(__props.title), 9, _hoisted_4$1),
            _createElementVNode$1("span", null, _toDisplayString$1(__props.items.length) + " 张", 1)
          ]),
          __props.expanded ? (_openBlock$1(), _createElementBlock$1("button", {
            key: 0,
            type: "button",
            class: "yh-history-poster-stack__close",
            "aria-label": "收起海报",
            onClick: _cache[0] || (_cache[0] = _withModifiers$1(($event) => emit("close"), ["stop"]))
          }, [
        ...
        _createElementVNode$1("div", {
          ...
          onClick: _cache[1] || (_cache[1] = _withModifiers$1(($event) => __props.expanded ? emit("close") : emit("toggle"), ["self"]))
        }, [
          (_openBlock$1(true), _createElementBlock$1(_Fragment$1, null, _renderList$1(__props.items, (item, index) => {
            return _openBlock$1(), _createElementBlock$1("button", {
              key: itemKey(item),
              type: "button",
              class: _normalizeClass$1(["yh-history-poster-stack__poster", {
              ...
              style: _normalizeStyle$1(stackStyle(index)),
              ...
              onClick: _withModifiers$1(($event) => __props.expanded ? emit("select", item) : emit("toggle"), ["stop"])
            }, [
              _createElementVNode$1("span", _hoisted_7$1, [
                ...
                }, null, 40, _hoisted_8$1)) : (_openBlock$1(), _createElementBlock$1("span", _hoisted_9$1, [
                  _createVNode$1(_component_v_icon, {
                    icon: "mdi-image-off-outline",
                    size: "24"
                  })
                ])),
                __props.expanded && __props.selectedKeys.includes(selectionKey(item)) ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_10$1, [
                  _createVNode$1(_component_v_icon, {
                    icon: "mdi-check",
                    size: "17"
                  })
              ...
              __props.expanded ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_11$1, [
                _createElementVNode$1("strong", {
                  title: item.library || item.name || "未知媒体库"
                }, _toDisplayString$1(item.library || item.name || "未知媒体库"), 9, _hoisted_12$1),
                _createElementVNode$1("span", {
                  title: item.server || "未知服务器"
                }, _toDisplayString$1(item.server || "未知服务器"), 9, _hoisted_13$1)
              ])) : _createCommentVNode$1("", true)
            ], 14, _hoisted_6$1);
          }), 128)),
          !__props.expanded && __props.items.length > __props.stackLimit ? (_openBlock$1(), _createElementBlock$1("span", _hoisted_14$1, " +" + _toDisplayString$1(__props.items.length - __props.stackLimit), 1)) : _createCommentVNode$1("", true)
        ], 8, _hoisted_5$1)
      ], 42, _hoisted_1$1);
    };
  }
...
const HistoryPosterStack = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a71a7b31"]]);
...
async function getPreviewCache(baseKey, requiredItems) {
  ...
  return previewCachePayload(match.payload);
}
...
const _hoisted_24 = ["aria-label", "aria-busy", "disabled"];
const _hoisted_25 = {
  class: "mcr-preview-refresh__icon",
  "aria-hidden": "true"
};
const _hoisted_26 = { class: "mcr-editor-save-cluster" };
const _hoisted_27 = { class: "mcr-editor-split-save" };
const _hoisted_28 = ["disabled"];
const _hoisted_29 = ["aria-label", "title", "disabled"];
const _hoisted_30 = { class: "mcr-editor-save-mode" };
const _hoisted_31 = {
  key: 1,
...
const _hoisted_35 = { class: "mcr-render-option" };
const _hoisted_36 = { class: "yh-field-label" };
const _hoisted_37 = {
  key: 0,
  class: "yh-inline-lock-badge"
};
const _hoisted_38 = ["disabled"];
const _hoisted_39 = { value: "DateCreated" };
const _hoisted_40 = { class: "mcr-render-option" };
...
const _hoisted_44 = { class: "mcr-collapsible-heading__title" };
const _hoisted_45 = { class: "mcr-panel__title" };
const _hoisted_46 = ["aria-pressed", "aria-disabled", "disabled", "onKeydown"];
const _hoisted_47 = {
  key: 0,
  class: "mcr-animated-parameter-panel"
};
const _hoisted_48 = { class: "mcr-animated-parameter-panel__header" };
const _hoisted_49 = { class: "mcr-animated-settings__grid" };
const _hoisted_50 = {
  key: 3,
  class: "mcr-note"
};
const _hoisted_51 = { class: "mcr-animated-parameter-panel__actions" };
...
const _hoisted_63 = ["aria-current", "onClick"];
const _hoisted_64 = ["onClick"];
const _hoisted_65 = ["data-mcr-theme"];
const _hoisted_66 = { class: "mcr-history-selection-count" };
...
const _hoisted_78 = { class: "mcr-donation-title" };
const _hoisted_79 = { class: "mcr-donation-subtitle" };
const _hoisted_80 = {
...
const _hoisted_82 = { class: "mcr-donation-stat-card" };
const _hoisted_83 = { class: "mcr-donation-stat-card__top" };
const _hoisted_84 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--static" };
const _hoisted_85 = { class: "mcr-donation-stat-card" };
const _hoisted_86 = { class: "mcr-donation-stat-card__top" };
const _hoisted_87 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--dynamic" };
const _hoisted_88 = { class: "mcr-donation-stat-card" };
const _hoisted_89 = { class: "mcr-donation-stat-card__top" };
const _hoisted_90 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--history" };
const _hoisted_91 = { class: "mcr-donation-stat-card" };
const _hoisted_92 = { class: "mcr-donation-stat-card__top" };
const _hoisted_93 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--run" };
const _hoisted_94 = {
  key: 3,
...
const _hoisted_97 = { class: "mcr-donation-card__actions" };
const _hoisted_98 = {
  key: 5,
  ...
  setup(__props, { emit: __emit }) {
    ...
    const groupedHistory = computed(() => {
      ...
      for (const item of sortedHistory.value) {
        ...
        const fullTitle = historyGroupMode.value === "library" ? `${item.server || "未知服务器"} · ${libraryName}` : formatDateTime(timestamp);
        if (!groups.has(key)) {
    ...
    let timeMachineResizeObserver = null;
    let timeMachineScrollRoot = null;
    const historyGroupsEl = ref(null);
    const timeMachineTimelineEl = ref(null);
    const timeMachineTimelineStyle = ref({ left: "12px", top: "80px" });
    ...
    watch([historyGroupMode, pageTab, groupedHistory], () => void nextTick(() => {
      observeTimeRecords();
      updateTimeMachineTimelinePosition();
    }));
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", {
        ...
        _cache[117] || (_cache[117] = _createElementVNode("div", { class: "mcr-shell__aurora" }, null, -1)),
        _cache[118] || (_cache[118] = _createElementVNode("div", { class: "mcr-shell__noise" }, null, -1)),
                      ...
                      _createElementVNode("div", _hoisted_3, [
                        _createElementVNode("div", _hoisted_4, [
                          _createElementVNode("div", _hoisted_5, [
                            ...
                            _cache[51] || (_cache[51] = _createElementVNode("h1", {
                            ...
                            _createElementVNode("div", {
                              ...
                              _createElementVNode("section", {
                                ...
                                isEditingLayout.value && customStaticLayout.value ? (_openBlock(), _createBlock(CustomLayoutEditor, {
                                    ...
                                    _createElementVNode("span", _hoisted_26, [
                                      _createElementVNode("span", _hoisted_27, [
                                        ...
                                        _createElementVNode("button", {
                                          ...
                                          _createElementVNode("span", _hoisted_30, _toDisplayString(editorAutoSaveEnabled.value ? "AUTO" : "MANUAL"), 1)
                                        ], 8, _hoisted_29)
                                      ])
                                    ]),
                                    _createVNode(_component_v_btn, {
                                  ...
                                  _: 1
                                }, 8, ["model-value", "preview-source", "params", "floating-tools-visible", "theme", "api"])) : (_openBlock(), _createElementBlock("div", _hoisted_31, [
                                ...
                                !isEditingLayout.value ? (_openBlock(), _createElementBlock("div", _hoisted_32, [
                                  _createElementVNode("label", _hoisted_33, [
                                    _cache[59] || (_cache[59] = _createElementVNode("span", null, "海报来源", -1)),
                                  ...
                                  _createElementVNode("label", _hoisted_35, [
                                    _createElementVNode("span", _hoisted_36, [
                                      _cache[60] || (_cache[60] = _createElementVNode("span", null, "封面来源排序", -1)),
                                      sourceSortLocked.value ? (_openBlock(), _createElementBlock("span", _hoisted_37, "已锁定")) : _createCommentVNode("", true)
                                    ]),
                                    _withDirectives(_createElementVNode("select", {
                                      ...
                                      _cache[61] || (_cache[61] = _createElementVNode("option", { value: "Random" }, "随机", -1)),
                                      _createElementVNode("option", _hoisted_39, _toDisplayString(sourceSortLocked.value ? "最新入库（已锁定）" : "最新入库"), 1),
                                      _cache[62] || (_cache[62] = _createElementVNode("option", { value: "PremiereDate" }, "最新发行", -1))
                                    ], 40, _hoisted_38), [
                                      [_vModelSelect, sourceSortBy.value]
                                    ])
                                  ]),
                                  _createElementVNode("label", _hoisted_40, [
                                    _cache[64] || (_cache[64] = _createElementVNode("span", null, "分辨率", -1)),
                                    ...
                                    ]) : (_openBlock(), _createElementBlock("span", _hoisted_42, _toDisplayString(animatedResolutionLabel.value), 1))
                                  ])
                                ])) : _createCommentVNode("", true)
                              ], 2),
                              !isEditingLayout.value ? (_openBlock(), _createElementBlock("aside", {
                                ...
                                _createElementVNode("div", {
                                  ...
                                  _createElementVNode("div", _hoisted_44, [
                                    _cache[66] || (_cache[66] = _createElementVNode("div", { class: "mcr-panel__eyebrow" }, "Presets", -1)),
                                    _createElementVNode("div", _hoisted_45, [
                                      _cache[65] || (_cache[65] = _createTextVNode(" 封面方案 ", -1)),
                                      _createVNode(_component_v_icon, {
                                        icon: "mdi-chevron-up",
                                        size: "20",
                                  ...
                                  _createVNode(_Transition, { name: "mcr-mode-switch" }, {
                                    default: _withCtx(() => [
                                      ...
                                      ])], 42, _hoisted_46)) : _createCommentVNode("", true)
                                    ]),
                                    _: 1
                                  })
                                ], 42, _hoisted_43),
                                _createVNode(_Transition, { name: "mcr-list-collapse" }, {
                                  default: _withCtx(() => [
                                    _withDirectives(_createElementVNode("div", {
                                      ...
                                      animatedSettingsPanelOpen.value ? (_openBlock(), _createElementBlock("div", _hoisted_47, [
                                        _createElementVNode("div", _hoisted_48, [
                                          ...
                                          _createElementVNode("div", null, [
                                            _cache[68] || (_cache[68] = _createElementVNode("span", null, "Motion Settings", -1)),
                                        ...
                                        _createElementVNode("div", _hoisted_49, [
                                          ...
                                          animatedSettingsBaseStyle.value === "static_3" ? (_openBlock(), _createElementBlock("p", _hoisted_50, " 方案 3 使用固定九宫格滚动，素材数量按 9 张处理。 ")) : _createCommentVNode("", true)
                                        ]),
                        ...
                        _createVNode(_component_v_window_item, { value: "history-tab" }, {
                          default: _withCtx(() => [
                            _createElementVNode("div", {
                              ...
                              onClick: _cache[28] || (_cache[28] = ($event) => historyListCollapsed.value = !historyListCollapsed.value),
                              onKeydown: [
                                _cache[29] || (_cache[29] = _withKeys(_withModifiers(($event) => historyListCollapsed.value = !historyListCollapsed.value, ["prevent"]), ["enter"])),
                                _cache[30] || (_cache[30] = _withKeys(_withModifiers(($event) => historyListCollapsed.value = !historyListCollapsed.value, ["prevent"]), ["space"]))
                              ]
                            }, [
                              _createElementVNode("div", _hoisted_60, [
                                _cache[78] || (_cache[78] = _createElementVNode("div", { class: "mcr-panel__eyebrow" }, "History", -1)),
                                _createElementVNode("div", _hoisted_61, [
                                  _cache[77] || (_cache[77] = _createTextVNode(" 历史封面 ", -1)),
                                  _createVNode(_component_v_icon, {
                                    icon: "mdi-chevron-up",
                                    size: "20",
                                    class: "mcr-collapsible-heading__icon",
                              ...
                              _createVNode(_Transition, { name: "mcr-heading-tools" }, {
                                default: _withCtx(() => [
                                  !historyListCollapsed.value ? (_openBlock(), _createElementBlock("div", {
                                    ...
                                    onKeydown: _cache[27] || (_cache[27] = _withModifiers(() => {
                                    }, ["stop"]))
                                  }, [
                                    ...
                                    _createVNode(BlueprintSelect, {
                                      ...
                                      "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => historySortMode.value = $event),
                            ...
                            (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
                              pageTab.value === "history-tab" && historyGroupMode.value === "time-machine" && groupedHistory.value.length ? (_openBlock(), _createElementBlock("nav", {
                                key: 0,
                                ref_key: "timeMachineTimelineEl",
                                ref: timeMachineTimelineEl,
                                class: "mcr-time-machine-timeline",
                                style: _normalizeStyle(timeMachineTimelineStyle.value),
                                "data-mcr-theme": isDark.value ? "dark" : "light",
                                "aria-label": "历史时间轴"
                              }, [
                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedHistory.value, (group) => {
                                  return _openBlock(), _createElementBlock("div", {
                                    key: group.key,
                                    class: "mcr-time-machine-node-row"
                                  }, [
                                    _createElementVNode("button", {
                                      type: "button",
                                      ...
                                      _cache[81] || (_cache[81] = _createElementVNode("i", { "aria-hidden": "true" }, null, -1)),
                                      _createElementVNode("span", null, _toDisplayString(group.title), 1)
                                    ], 10, _hoisted_63),
                                    activeTimeRecordId.value === group.key ? (_openBlock(), _createElementBlock("button", {
                                      key: 0,
                                      type: "button",
                                      class: "mcr-time-machine-restore",
                                      onClick: _withModifiers(($event) => restoreHistoryBatch(group.key, group.title), ["stop"])
                                    }, "回到此时", 8, _hoisted_64)) : _createCommentVNode("", true)
                                  ]);
                                }), 128))
                            ...
                            (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
                              expandedHistoryGroupId.value && selectedHistoryPaths.value.length ? (_openBlock(), _createElementBlock("div", {
                                ...
                                _createElementVNode("span", _hoisted_66, "已选择 " + _toDisplayString(selectedHistoryPaths.value.length), 1),
                                _createElementVNode("button", {
                                  type: "button",
                                ...
                                }, _toDisplayString(allHistorySelected.value ? "取消全选" : "全选"), 41, _hoisted_67),
                                _createElementVNode("button", {
                                  type: "button",
                                ...
                                }, "应用", 8, _hoisted_70)) : _createCommentVNode("", true),
                                _createElementVNode("button", {
                                  type: "button",
                              ...
                              ], 8, _hoisted_65)) : _createCommentVNode("", true)
                            ])),
                            _createVNode(_Transition, { name: "mcr-list-collapse" }, {
                              default: _withCtx(() => [
                                  ...
                                  history.value.length ? (_openBlock(), _createElementBlock("div", {
                                    ...
                                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedHistory.value, (group) => {
                                      return _openBlock(), _createElementBlock("section", {
                                        key: group.key,
                                        class: _normalizeClass(["mcr-history-group", { "mcr-history-group--time-machine": historyGroupMode.value === "time-machine", "is-active": activeTimeRecordId.value === group.key, "is-expanded": expandedHistoryGroupId.value === group.key, "is-dimmed": Boolean(expandedHistoryGroupId.value && expandedHistoryGroupId.value !== group.key) }]),
                                        ...
                                        _createVNode(HistoryPosterStack, {
                                          ...
                                          title: group.title,
                                          items: group.items,
                                          expanded: expandedHistoryGroupId.value === group.key,
                                          ...
                                          disabled: controlsLocked.value,
                                          onToggle: ($event) => openHistorySnapshot(group),
                                          onClose: _cache[35] || (_cache[35] = ($event) => closeHistorySnapshot()),
                                          onSelect: toggleHistorySelection
                                        }, null, 8, ["group-key", "title", "items", "expanded", "phase", "selected-keys", "stack-limit", "mode", "disabled", "onToggle"])
                                      ], 10, _hoisted_73);
                                    }), 128))
                                  ], 2)) : (_openBlock(), _createElementBlock("div", _hoisted_74, [..._cache[82] || (_cache[82] = [
        ...
        _createVNode(_component_v_dialog, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card, {
              ...
              default: _withCtx(() => [
                _cache[85] || (_cache[85] = _createElementVNode("h3", null, "确定回到此时吗？", -1)),
                _createElementVNode("p", null, _toDisplayString(pendingHistoryRestore.value?.label), 1),
                _cache[86] || (_cache[86] = _createElementVNode("p", null, "将把该时间保存的封面重新应用到对应服务器媒体库。当前服务器上的封面会被替换，但历史记录不会被删除。", -1)),
        ...
        _createVNode(_component_v_dialog, {
          ...
          "onUpdate:modelValue": _cache[41] || (_cache[41] = ($event) => donationDialog.value = $event),
          "max-width": "460",
            ...
            _createVNode(_component_v_card, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_card_text, { class: "mcr-donation-card__body" }, {
                  default: _withCtx(() => [
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_75, [
                      _createElementVNode("div", {
                        ...
                        donationAvatarImage.value ? (_openBlock(), _createElementBlock("img", {
                          ...
                          src: donationAvatarImage.value,
                          alt: ""
                        }, null, 8, _hoisted_76)) : (_openBlock(), _createBlock(_component_v_icon, {
                          key: 1,
                          icon: donationAvatarIcon.value,
                          size: "38"
                        }, null, 8, ["icon"])),
                      ...
                      _createElementVNode("h3", _hoisted_78, _toDisplayString(donationView.value === "support" ? "感谢您的支持" : "呀哈哈封面工坊"), 1),
                      _createElementVNode("div", _hoisted_79, _toDisplayString(donationView.value === "support" ? "Heartfelt giving" : "使用数据统计"), 1)
                    ])) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                      ...
                      _cache[87] || (_cache[87] = _createElementVNode("h3", { class: "mcr-donation-title" }, "感谢您的支持", -1))
                    ], 64)),
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_81, [
                      _createElementVNode("div", _hoisted_82, [
                        _createElementVNode("div", _hoisted_83, [
                          ...
                          _cache[88] || (_cache[88] = _createElementVNode("small", null, "Active", -1))
                        ]),
                        _createElementVNode("strong", null, _toDisplayString(donationStaticSchemeCount.value), 1),
                        _cache[89] || (_cache[89] = _createElementVNode("span", null, "静态方案", -1))
                      ]),
                      ...
                      _createElementVNode("div", _hoisted_88, [
                        ...
                        _cache[92] || (_cache[92] = _createElementVNode("span", null, "历史封面", -1))
                      ]),
                      _createElementVNode("div", _hoisted_91, [
                        ...
                        _cache[93] || (_cache[93] = _createElementVNode("span", null, "执行次数", -1))
                      ])
                    ])) : _createCommentVNode("", true),
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_94, [
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("p", _hoisted_96, " 您的慷慨支持是我持续创作的动力。 ")) : _createCommentVNode("", true),
                    _createElementVNode("div", _hoisted_97, [
                      donationView.value === "support" ? (_openBlock(), _createBlock(_component_v_btn, {
                        ...
                        onClick: _cache[39] || (_cache[39] = ($event) => donationDialog.value = false)
                      }, {
                      ...
                      donationView.value === "overview" ? (_openBlock(), _createBlock(_component_v_btn, {
                        ...
                        onClick: _cache[40] || (_cache[40] = ($event) => donationView.value = "support")
                      }, {
                        default: _withCtx(() => [
                          _createVNode(_component_v_icon, {
                          ...
                          _cache[95] || (_cache[95] = _createElementVNode("span", null, "继续支持", -1))
                        ]),
                        _: 1
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[96] || (_cache[96] = _createElementVNode("span", null, "已支持", -1))
                        ]),
                        _: 1
                      }))
                    ]),
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_98, "HEARTFELT GIVING • LUMINOUS CHARITY")) : _createCommentVNode("", true)
                  ]),
                  _: 1
                })
              ]),
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a3024b5e"]]);
