import { importShared } from './__federation_fn_import-ui-rev-20260713-01.js';
import { _ as _export_sfc } from './_plugin-vue_export-helper-ui-rev-20260713-01.js';
import { g as getTemplateFontFamilyStack, S as SEMANTIC_FONT_ITEMS, B as BUILTIN_FONT_ITEMS, a as getTemplateFontFaceName, b as BlueprintField, c as BlueprintSelect, M as MCR_CONTROL_DEFAULTS, A as AsyncStatusDots, V as ViewportSaveToast } from './ViewportSaveToast-ui-rev-20260713-01.js';
...
const _hoisted_73 = { class: "mcr-history-group__heading" };
const _hoisted_74 = { class: "mcr-history-group__title" };
const _hoisted_75 = ["aria-label", "onClick"];
const _hoisted_76 = ["src", "alt"];
const _hoisted_77 = {
  key: 0,
  class: "mcr-time-machine-stack__more"
};
const _hoisted_78 = { class: "mcr-history-card__media" };
const _hoisted_79 = ["aria-pressed", "aria-label", "disabled", "onClick"];
const _hoisted_80 = { class: "mcr-history-card__title" };
...
const _hoisted_86 = ["aria-pressed", "onClick"];
const _hoisted_87 = {
  key: 0,
  class: "mcr-history-snapshot__footer"
};
const _hoisted_88 = {
  key: 0,
...
const _hoisted_91 = { class: "mcr-donation-title" };
const _hoisted_92 = { class: "mcr-donation-subtitle" };
const _hoisted_93 = {
...
const _hoisted_95 = { class: "mcr-donation-stat-card" };
const _hoisted_96 = { class: "mcr-donation-stat-card__top" };
const _hoisted_97 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--static" };
const _hoisted_98 = { class: "mcr-donation-stat-card" };
const _hoisted_99 = { class: "mcr-donation-stat-card__top" };
const _hoisted_100 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--dynamic" };
const _hoisted_101 = { class: "mcr-donation-stat-card" };
const _hoisted_102 = { class: "mcr-donation-stat-card__top" };
const _hoisted_103 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--history" };
const _hoisted_104 = { class: "mcr-donation-stat-card" };
const _hoisted_105 = { class: "mcr-donation-stat-card__top" };
const _hoisted_106 = { class: "mcr-donation-stat-icon mcr-donation-stat-icon--run" };
const _hoisted_107 = {
  key: 3,
...
const _hoisted_110 = { class: "mcr-donation-card__actions" };
const _hoisted_111 = {
  key: 5,
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function refreshCurrentPreview() {
      ...
      try {
        await loadPreviewSources(void 0, true);
        if (previewMode.value === "backend") {
          await loadBackendPreview();
        }
      } finally {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", {
        ...
        _cache[126] || (_cache[126] = _createElementVNode("div", { class: "mcr-shell__aurora" }, null, -1)),
        _cache[127] || (_cache[127] = _createElementVNode("div", { class: "mcr-shell__noise" }, null, -1)),
                        ...
                        _createVNode(_component_v_window_item, { value: "history-tab" }, {
                          default: _withCtx(() => [
                            ...
                            (_openBlock(), _createBlock(_Teleport, { to: "body" }, [
                              ...
                              ], 12, _hoisted_64)) : _createCommentVNode("", true)
                            ])),
                            _createVNode(_Transition, { name: "mcr-list-collapse" }, {
                              default: _withCtx(() => [
                                _withDirectives(_createElementVNode("div", _hoisted_70, [
                                  history.value.length ? (_openBlock(), _createElementBlock("div", _hoisted_71, [
                                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedHistory.value, (group) => {
                                      return _openBlock(), _createElementBlock("section", {
                                        ...
                                        historyGroupMode.value === "time-machine" ? (_openBlock(), _createElementBlock("button", {
                                          ...
                                          group.items.length > historyStackLimit.value ? (_openBlock(), _createElementBlock("span", _hoisted_77, "+" + _toDisplayString(group.items.length - historyStackLimit.value), 1)) : _createCommentVNode("", true)
                                        ], 8, _hoisted_75)) : (_openBlock(), _createBlock(_component_v_row, { key: 1 }, {
                                          default: _withCtx(() => [
                                                  ...
                                                  _createVNode(_component_v_card, {
                                                    ...
                                                    default: _withCtx(() => [
                                                      _createElementVNode("div", _hoisted_78, [
                                                        ...
                                                        _createElementVNode("div", _hoisted_80, _toDisplayString(item.library || item.name), 1)
                                                      ]),
                                  ...
                                  ])) : (_openBlock(), _createElementBlock("div", _hoisted_82, [..._cache[86] || (_cache[86] = [
        ...
        _createVNode(_component_v_dialog, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card, {
              ...
              default: _withCtx(() => [
                _cache[89] || (_cache[89] = _createElementVNode("h3", null, "确定回到此时吗？", -1)),
                _createElementVNode("p", null, _toDisplayString(pendingHistoryRestore.value?.label), 1),
                _cache[90] || (_cache[90] = _createElementVNode("p", null, "将把该时间保存的封面重新应用到对应服务器媒体库。当前服务器上的封面会被替换，但历史记录不会被删除。", -1)),
            ...
            selectedHistorySnapshot.value ? (_openBlock(), _createBlock(_component_v_card, {
              ...
              default: _withCtx(() => [
                _createElementVNode("header", _hoisted_83, [
                  _createElementVNode("div", null, [
                    _cache[91] || (_cache[91] = _createElementVNode("span", null, "History", -1)),
                    _cache[92] || (_cache[92] = _createElementVNode("h3", null, "此时的封面", -1)),
                ...
                _createElementVNode("div", _hoisted_84, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedHistorySnapshot.value.items, (item) => {
                    return _openBlock(), _createElementBlock("article", {
                      ...
                      _createElementVNode("button", {
                        type: "button",
                        class: _normalizeClass(["mcr-history-snapshot__check", { "is-active": selectedHistoryPaths.value.includes(item.path) }]),
                        "aria-pressed": selectedHistoryPaths.value.includes(item.path),
                        onClick: ($event) => toggleHistorySelection(item)
                      }, [
                        _createVNode(_component_v_icon, {
                          icon: selectedHistoryPaths.value.includes(item.path) ? "mdi-check" : "mdi-plus",
                          size: "16"
                        }, null, 8, ["icon"])
                      ], 10, _hoisted_86)
                    ]);
                ...
                selectedHistoryPaths.value.length ? (_openBlock(), _createElementBlock("footer", _hoisted_87, [
                  _createElementVNode("span", null, "已选择 " + _toDisplayString(selectedHistoryPaths.value.length) + " 项", 1),
                  _createVNode(_component_v_btn, {
                    class: "mcr-button mcr-button--ghost",
                    onClick: downloadSelectedCoversDirect
                  }, {
                  ...
                  _createVNode(_component_v_btn, {
                    ...
                    default: _withCtx(() => [..._cache[94] || (_cache[94] = [
                      _createTextVNode("应用到服务器", -1)
                    ])]),
                    _: 1
                  }, 8, ["loading"]),
                  _createVNode(_component_v_btn, {
                    class: "mcr-button mcr-button--danger",
            ...
            _createVNode(_component_v_card, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_v_card_text, { class: "mcr-donation-card__body" }, {
                  default: _withCtx(() => [
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_88, [
                      _createElementVNode("div", {
                        ...
                        donationAvatarImage.value ? (_openBlock(), _createElementBlock("img", {
                          ...
                          src: donationAvatarImage.value,
                          alt: ""
                        }, null, 8, _hoisted_89)) : (_openBlock(), _createBlock(_component_v_icon, {
                          key: 1,
                          icon: donationAvatarIcon.value,
                          size: "38"
                        }, null, 8, ["icon"])),
                      ...
                      _createElementVNode("h3", _hoisted_91, _toDisplayString(donationView.value === "support" ? "感谢您的支持" : "呀哈哈封面工坊"), 1),
                      _createElementVNode("div", _hoisted_92, _toDisplayString(donationView.value === "support" ? "Heartfelt giving" : "使用数据统计"), 1)
                    ])) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                      ...
                      _cache[96] || (_cache[96] = _createElementVNode("h3", { class: "mcr-donation-title" }, "感谢您的支持", -1))
                    ], 64)),
                    donationView.value === "overview" ? (_openBlock(), _createElementBlock("div", _hoisted_94, [
                      _createElementVNode("div", _hoisted_95, [
                        _createElementVNode("div", _hoisted_96, [
                          ...
                          _cache[97] || (_cache[97] = _createElementVNode("small", null, "Active", -1))
                        ]),
                      ...
                      _createElementVNode("div", _hoisted_98, [
                        _createElementVNode("div", _hoisted_99, [
                          ...
                          _cache[99] || (_cache[99] = _createElementVNode("small", {
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_107, [
                      _createElementVNode("img", {
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("p", _hoisted_109, " 您的慷慨支持是我持续创作的动力。 ")) : _createCommentVNode("", true),
                    ...
                    donationView.value === "support" ? (_openBlock(), _createElementBlock("div", _hoisted_111, "HEARTFELT GIVING • LUMINOUS CHARITY")) : _createCommentVNode("", true)
                  ]),
                  _: 1
                })
              ]),
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6f3610fb"]]);
