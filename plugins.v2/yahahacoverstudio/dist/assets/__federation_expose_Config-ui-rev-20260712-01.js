...
import { B as BUILTIN_FONT_ITEMS, M as MCR_CONTROL_DEFAULTS, b as BlueprintField, c as BlueprintSelect, A as AsyncStatusDots, V as ViewportSaveToast, a as getTemplateFontFaceName } from './ViewportSaveToast-ui-rev-20260712-01.js';

const UI_REV = "20260712-01";
const PROGRAM_VERSION = "2.0.1";

const {defineComponent:_defineComponent$1} = await importShared('vue');

const {renderList:_renderList$1,Fragment:_Fragment$1,openBlock:_openBlock$1,createElementBlock:_createElementBlock$1,createElementVNode:_createElementVNode$1,mergeProps:_mergeProps,toDisplayString:_toDisplayString$1,resolveComponent:_resolveComponent$1,withCtx:_withCtx$1,createBlock:_createBlock$1,Teleport:_Teleport} = await importShared('vue');
...
const _sfc_main$1 = /* @__PURE__ */ _defineComponent$1({
  ...
  setup(__props) {
    ...
    watch$1(() => [props.sections, props.scrollContainer], () => void nextTick$1(setupObserver), { deep: true });
    onMounted$1(() => void nextTick$1(setupObserver));
    onBeforeUnmount$1(() => {
      observer?.disconnect();
      if (clickUnlockTimer !== null) window.clearTimeout(clickUnlockTimer);
    });
...
const SettingsAnchorNav = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a6bc8c91"]]);
...
const _hoisted_61 = { class: "mcr-title-config-heading" };
                ...
                _createElementVNode("div", _hoisted_2, [
                  ...
                  _createElementVNode("div", _hoisted_15, [
                    ...
                    _createElementVNode("main", _hoisted_18, [
                      ...
                      }, null, 8, ["theme"])) : _createCommentVNode("", true),
                      ...
                      _createElementVNode("div", _hoisted_64, "前端 UI " + _toDisplayString(_unref(UI_REV)) + " · 主程序 v" + _toDisplayString(_unref(PROGRAM_VERSION)), 1)
                    ])
                  ])
                ]),
...
const Config = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0d679443"]]);
