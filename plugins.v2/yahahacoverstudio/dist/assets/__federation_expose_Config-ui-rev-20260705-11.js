              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_2, [
                  _createElementVNode("header", _hoisted_3, [
                    _cache[29] || (_cache[29] = _createElementVNode("div", { class: "mcr-config-brand" }, [
                              ...
                              _createVNode(_component_v_card_text, { class: "mcr-panel__body mcr-config-tabbody mcr-config-section-stack" }, {
                                default: _withCtx(() => [
                                  ...
                                  _createElementVNode("section", _hoisted_21, [
                                    ...
                                    _cache[34] || (_cache[34] = _createElementVNode("p", { class: "yh-field-hint yh-monitor-hint" }, [
                                  ...
                                  _createElementVNode("section", _hoisted_24, [
                                    _cache[37] || (_cache[37] = _createElementVNode("header", { class: "mcr-config-section-card__header" }, [
                                      _createElementVNode("div", null, [
                                        ...
                                        _createElementVNode("p", { class: "mcr-config-section-card__copy" }, "保存生成记录，并控制历史页展示数量。")
                                      ])
                                    ], -1)),
                                    _createVNode(_component_v_row, {
                                      class: "mcr-form-grid mcr-form-grid--center",
                                      ...
                                      default: _withCtx(() => [
                                        ...
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createVNode(BlueprintField, {
                                              modelValue: config.value.covers_output,
                                              "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => config.value.covers_output = $event),
                                              label: "历史封面目录",
                                              hint: "留空时保存到插件数据目录"
                                            }, null, 8, ["modelValue"])
                                          ]),
                                        ...
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createVNode(BlueprintField, {
                                              modelValue: config.value.covers_history_limit_per_library,
                                              "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => config.value.covers_history_limit_per_library = $event),
                                              modelModifiers: { number: true },
                                              type: "number",
                                              label: "单库上限",
                                              hint: "默认 10"
                                        ...
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createVNode(BlueprintField, {
                                              modelValue: config.value.covers_page_history_limit,
                                              "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => config.value.covers_page_history_limit = $event),
                                              modelModifiers: { number: true },
                                              type: "number",
                                              label: "显示数量",
                                              hint: "默认 50"
                                        ...
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createVNode(BlueprintSelect, {
                                              ...
                                              "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => config.value.main_title_font_preset = $event),
                                        ...
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createVNode(BlueprintSelect, {
                                              ...
                                              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => config.value.subtitle_font_preset = $event),
                                        ...
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createVNode(BlueprintSelect, {
                                              ...
                                              "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => config.value.custom_text_font_preset = $event),
                                              items: subtitleFontItems.value,
                                              label: "自定义文本字体"
                                            }, null, 8, ["modelValue", "items"])
                                          ]),
                                    ...
                                    _createElementVNode("div", _hoisted_26, [
                                      ...
                                      _createElementVNode("div", _hoisted_32, [
                                        _createElementVNode("button", {
                                          ...
                                          onClick: _cache[19] || (_cache[19] = ($event) => fontLibraryExpanded.value = !fontLibraryExpanded.value)
                                        }, [
                                          _createVNode(_component_v_icon, {
                                    ...
                                    _createElementVNode("div", _hoisted_42, [
                                      _createElementVNode("div", null, [
                                        _createVNode(BlueprintField, {
                                          ...
                                          "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => config.value.backup_path = $event),
                                          label: "备份本地路径",
                                      ...
                                      _createElementVNode("div", null, [
                                        _createVNode(BlueprintField, {
                                          ...
                                          "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => config.value.backup_cron = $event),
                                          label: "备份 cron",
                                          placeholder: "0 4 * * *",
                                      ...
                                      _createElementVNode("div", _hoisted_43, [
                                        _createElementVNode("div", _hoisted_44, [
                                          ...
                                          _createElementVNode("button", {
                                            type: "button",
                                            class: "mcr-config-collapse-button",
                                            onClick: _cache[22] || (_cache[22] = ($event) => backupLibraryExpanded.value = !backupLibraryExpanded.value)
                                          }, [
                                            _createVNode(_component_v_icon, {
                              ...
                              _createVNode(_component_v_card_text, { class: "mcr-panel__body mcr-config-tabbody" }, {
                                default: _withCtx(() => [
                                  ...
                                  _createVNode(BlueprintField, {
                                    ...
                                    "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => config.value.title_config = $event),
                                    textarea: "",
                                    label: "主副标题配置 (YAML)",
                                    rows: "16",
                                    spellcheck: "false",
                                  ...
                                  _createElementVNode("div", { class: "mcr-title-config-reference" }, [
                                    _cache[53] || (_cache[53] = _createElementVNode("div", { class: "mcr-title-config-reference__label" }, "格式参考", -1)),
