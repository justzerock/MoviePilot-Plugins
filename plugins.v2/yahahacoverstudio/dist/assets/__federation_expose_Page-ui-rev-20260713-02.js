...
import { g as getTemplateFontFamilyStack, S as SEMANTIC_FONT_ITEMS, B as BUILTIN_FONT_ITEMS, a as getTemplateFontFaceName, b as BlueprintField, c as BlueprintSelect, M as MCR_CONTROL_DEFAULTS, A as AsyncStatusDots, V as ViewportSaveToast } from './ViewportSaveToast-ui-rev-20260713-02.js';
...
const _hoisted_85 = ["aria-checked", "onClick", "onKeydown"];
const _hoisted_86 = ["src", "alt"];
const _hoisted_87 = { class: "mcr-history-snapshot__labels" };
                  ...
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedHistorySnapshot.value.items, (item) => {
                    return _openBlock(), _createElementBlock("article", {
                      ...
                      _createElementVNode("div", _hoisted_87, [
                        ...
                        }, _toDisplayString(item.library || item.name), 9, _hoisted_88),
                        _createElementVNode("span", {
                          title: item.server || "未知服务器"
                        }, _toDisplayString(item.server || "未知服务器"), 9, _hoisted_89)
                      ])
                    ], 42, _hoisted_85);
                  }), 128))
                ]),
                selectedHistoryPaths.value.length ? (_openBlock(), _createElementBlock("footer", _hoisted_90, [
...
const Page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3b73e937"]]);
