import { importShared } from './__federation_fn_import-ui-rev-20260718-02.js';
import { _ as _export_sfc } from './_plugin-vue_export-helper-ui-rev-20260718-02.js';
import { c as getTemplateFontFaceName, B as BUILTIN_FONT_ITEMS, M as MCR_CONTROL_DEFAULTS, a as BlueprintField, b as BlueprintSelect, A as AsyncStatusDots, V as ViewportSaveToast, l as loadPreviewFontFaces } from './ViewportSaveToast-ui-rev-20260718-02.js';

const UI_REV = "20260718-02";
const PROGRAM_VERSION = "2.2.5";

const {defineComponent:_defineComponent$1} = await importShared('vue');

const {renderList:_renderList$1,Fragment:_Fragment$1,openBlock:_openBlock$1,createElementBlock:_createElementBlock$1,createElementVNode:_createElementVNode$1,withModifiers:_withModifiers$1,mergeProps:_mergeProps,toDisplayString:_toDisplayString$1,resolveComponent:_resolveComponent$1,withCtx:_withCtx$1,createBlock:_createBlock$1,normalizeStyle:_normalizeStyle$1,createCommentVNode:_createCommentVNode$1,Teleport:_Teleport} = await importShared('vue');
...
const {createElementVNode:_createElementVNode,unref:_unref,normalizeStyle:_normalizeStyle,resolveComponent:_resolveComponent,createVNode:_createVNode,toDisplayString:_toDisplayString,openBlock:_openBlock,createElementBlock:_createElementBlock,createCommentVNode:_createCommentVNode,normalizeClass:_normalizeClass,withCtx:_withCtx,renderList:_renderList,Fragment:_Fragment,createBlock:_createBlock,createTextVNode:_createTextVNode,vModelText:_vModelText,withDirectives:_withDirectives,withModifiers:_withModifiers} = await importShared('vue');
...
const _hoisted_10 = { class: "mcr-config-tag" };
...
const _hoisted_13 = ["aria-selected", "onClick"];
const _hoisted_14 = { class: "mcr-config-workspace" };
const _hoisted_15 = {
...
const _hoisted_18 = { class: "yh-switch-row" };
const _hoisted_19 = {
...
const _hoisted_22 = { class: "mcr-config-section-card__header" };
const _hoisted_23 = { class: "mcr-config-scheme-rule__fields" };
const _hoisted_24 = {
  id: "settings-images",
  class: "mcr-config-section-card"
};
...
const _hoisted_27 = { class: "mcr-font-switch-card" };
const _hoisted_28 = { class: "mcr-font-switch-card" };
const _hoisted_29 = { class: "mcr-font-switch-card" };
const _hoisted_30 = { class: "mcr-font-library" };
const _hoisted_31 = { class: "mcr-font-library__header" };
const _hoisted_32 = { class: "mcr-font-library__import" };
const _hoisted_33 = { class: "mcr-font-link-field" };
const _hoisted_34 = { class: "mcr-font-link-field__control" };
const _hoisted_35 = ["disabled"];
const _hoisted_36 = { class: "mcr-font-library__listbar" };
const _hoisted_37 = {
  key: 0,
...
const _hoisted_41 = { class: "mcr-font-item__name" };
...
const _hoisted_46 = { class: "mcr-config-backup-grid mcr-config-backup-grid--cron-only" };
const _hoisted_47 = { class: "mcr-config-backup-grid__actions" };
const _hoisted_48 = { class: "mcr-config-backup-actions" };
const _hoisted_49 = {
  key: 0,
...
const _hoisted_53 = { class: "mcr-backup-item__main" };
const _hoisted_54 = ["title"];
const _hoisted_55 = { class: "mcr-backup-item__meta" };
const _hoisted_56 = { key: 0 };
const _hoisted_57 = { class: "mcr-backup-item__actions" };
...
const _hoisted_62 = { class: "mcr-config-clean-actions" };
const _hoisted_63 = { class: "mcr-config-clean-action" };
const _hoisted_64 = { class: "mcr-config-clean-action" };
const _hoisted_65 = { class: "mcr-title-config-heading" };
const _hoisted_66 = { class: "mcr-title-config-toolbar" };
const _hoisted_67 = { class: "mcr-title-config-mode" };
const _hoisted_68 = { class: "mcr-title-config-editor-shell" };
const _hoisted_69 = { class: "yh-ui-rev" };
...
`;
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", {
        ...
        _cache[69] || (_cache[69] = _createElementVNode("div", { class: "mcr-shell__aurora" }, null, -1)),
        _cache[70] || (_cache[70] = _createElementVNode("div", { class: "mcr-shell__noise" }, null, -1)),
              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_2, [
                    ...
                    _createElementVNode("div", _hoisted_4, [
                      _createElementVNode("div", _hoisted_5, [
                        _createElementVNode("button", {
                          ...
                          _createElementVNode("span", _hoisted_7, [
                            ...
                            isGenerating.value ? (_openBlock(), _createElementBlock("span", _hoisted_8, _toDisplayString(configGenerationProgressCount.value), 1)) : _createCommentVNode("", true)
                          ])
                        ], 14, _hoisted_6),
                      ...
                      _createElementVNode("div", _hoisted_9, [
                        _createElementVNode("span", _hoisted_10, [
                          _cache[34] || (_cache[34] = _createElementVNode("span", null, "状态", -1)),
                          _createElementVNode("strong", null, _toDisplayString(config.value.enabled ? "启用" : "停用"), 1)
                        ]),
                        _createElementVNode("span", _hoisted_11, [
                          _cache[35] || (_cache[35] = _createElementVNode("span", null, "调度", -1)),
                  ...
                  _createElementVNode("div", _hoisted_14, [
                    _createElementVNode("aside", _hoisted_15, [
                      _cache[36] || (_cache[36] = _createElementVNode("div", { class: "mcr-config-sidebar__label" }, "Sections", -1)),
                      (_openBlock(), _createElementBlock(_Fragment, null, _renderList(tabItems, (item) => {
                        return _createElementVNode("button", {
                          key: item.value,
                          type: "button",
                      ...
                      _cache[37] || (_cache[37] = _createElementVNode("div", { class: "mcr-config-sidebar__spacer" }, null, -1))
                    ]),
                    _createElementVNode("main", {
                              ...
                              _createVNode(_component_v_card_text, { class: "mcr-panel__body mcr-config-tabbody mcr-config-section-stack" }, {
                                default: _withCtx(() => [
                                  _createElementVNode("section", _hoisted_17, [
                                    _cache[38] || (_cache[38] = _createElementVNode("header", { class: "mcr-config-section-card__header" }, [
                                  ...
                                  _createElementVNode("section", _hoisted_19, [
                                    ...
                                    _cache[40] || (_cache[40] = _createElementVNode("p", { class: "yh-field-hint yh-monitor-hint" }, [
                                      ...
                                      return _openBlock(), _createElementBlock("div", {
                                        ...
                                        _createElementVNode("div", _hoisted_23, [
                                          ...
                                          _createVNode(_component_v_btn, {
                                            ...
                                            size: "small",
                                            variant: "text",
                                            class: "mcr-config-scheme-rule__remove",
                                            title: "删除规则",
                                  ...
                                  _createElementVNode("section", _hoisted_26, [
                                    _cache[53] || (_cache[53] = _createElementVNode("header", { class: "mcr-config-section-card__header" }, [
                                      _createElementVNode("div", null, [
                                        ...
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createElementVNode("div", _hoisted_27, [
                                              ...
                                              _cache[46] || (_cache[46] = _createElementVNode("p", null, "预览页与画布使用当前所选字体。", -1))
                                            ])
                                          ]),
                                          _: 1
                                        }),
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createElementVNode("div", _hoisted_28, [
                                              ...
                                              _cache[47] || (_cache[47] = _createElementVNode("p", null, "按当前文字生成轻量字体子集。", -1))
                                            ])
                                          ]),
                                          _: 1
                                        })
                                        ...
                                        _createVNode(_component_v_col, {
                                          ...
                                          default: _withCtx(() => [
                                            _createElementVNode("div", _hoisted_29, [
                                              ...
                                              _cache[48] || (_cache[48] = _createElementVNode("p", null, "缺字时适配字形，不修改配置原文。", -1))
                                            ])
                                          ]),
                                          _: 1
                                        }),
                                    ...
                                    _createElementVNode("div", _hoisted_30, [
                                      ...
                                      _createElementVNode("div", _hoisted_32, [
                                        _createElementVNode("label", _hoisted_33, [
                                          _cache[51] || (_cache[51] = _createElementVNode("span", { class: "mcr-blueprint-field__label" }, "网络字体链接", -1)),
                                          _createElementVNode("span", _hoisted_34, [
                                            ...
                                            ], 8, _hoisted_35)) : _createCommentVNode("", true)
                                          ]),
                                          _cache[52] || (_cache[52] = _createElementVNode("span", { class: "mcr-blueprint-field__hint" }, "支持 ttf / ttc / otf / woff / woff2，导入后保存到插件数据目录", -1))
                                        ])
                                      ]),
                                      ...
                                      fontLibraryExpanded.value && fontLibraryLoading.value ? (_openBlock(), _createElementBlock("div", _hoisted_37, "正在读取字体库...")) : fontLibraryExpanded.value && !customFontItems.value.length ? (_openBlock(), _createElementBlock("div", _hoisted_38, "暂无自定义字体")) : fontLibraryExpanded.value ? (_openBlock(), _createElementBlock("div", _hoisted_39, [
                                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(customFontItems.value, (item) => {
                                          return _openBlock(), _createElementBlock("button", {
                                            ...
                                            _createElementVNode("span", _hoisted_41, _toDisplayString(item.title), 1),
                                            _createElementVNode("span", {
                                              role: "button",
                                              tabindex: "-1",
                                      ...
                                      fontUploadMessage.value ? (_openBlock(), _createElementBlock("div", _hoisted_44, _toDisplayString(fontUploadMessage.value), 1)) : _createCommentVNode("", true)
                                    ])
                                  ]),
                                  _createElementVNode("section", _hoisted_45, [
                                    _cache[57] || (_cache[57] = _createElementVNode("header", { class: "mcr-config-section-card__header" }, [
                                      _createElementVNode("div", null, [
                                    ...
                                    _createElementVNode("div", _hoisted_46, [
                                      ...
                                      _createElementVNode("div", _hoisted_47, [
                                        ...
                                        backupLibraryExpanded.value ? (_openBlock(), _createElementBlock("div", _hoisted_49, [
                                          backupListLoading.value ? (_openBlock(), _createElementBlock("div", _hoisted_50, "正在读取备份记录...")) : !backupItems.value.length ? (_openBlock(), _createElementBlock("div", _hoisted_51, "暂无备份记录")) : (_openBlock(), _createElementBlock("div", _hoisted_52, [
                                              ...
                                              return _openBlock(), _createElementBlock("article", {
                                                ...
                                                _createElementVNode("div", _hoisted_53, [
                                                  _createElementVNode("div", {
                                                    ...
                                                    title: item.name
                                                  }, _toDisplayString(item.name), 9, _hoisted_54),
                                                  _createElementVNode("div", _hoisted_55, [
                                                    _createTextVNode(_toDisplayString(item.exported_at || item.mtime_label || "未知时间") + " ", 1),
                                                    item.version ? (_openBlock(), _createElementBlock("span", _hoisted_56, "v" + _toDisplayString(item.version), 1)) : _createCommentVNode("", true)
                                                  ])
                                                ]),
                                  ...
                                  _createElementVNode("section", _hoisted_61, [
                                    _cache[62] || (_cache[62] = _createElementVNode("header", { class: "mcr-config-section-card__header" }, [
                                      _createElementVNode("div", null, [
                          ...
                          _createVNode(_component_v_window_item, { value: "title-tab" }, {
                            default: _withCtx(() => [
                              _createVNode(_component_v_card_text, { class: "mcr-panel__body mcr-config-tabbody" }, {
                                default: _withCtx(() => [
                                  _cache[67] || (_cache[67] = _createElementVNode("div", { class: "mcr-panel__eyebrow" }, "Titles", -1)),
                                  _createElementVNode("div", _hoisted_65, [
                                    _cache[64] || (_cache[64] = _createElementVNode("div", { class: "mcr-panel__title" }, "主副标题配置", -1)),
                                    _createVNode(_component_v_btn, {
                                      size: "small",
                                  ...
                                  _cache[68] || (_cache[68] = _createElementVNode("p", { class: "mcr-panel__copy mcr-config-copy" }, " 严格模式按标准 YAML 校验；宽容模式会兼容中文冒号、冒号后无空格和部分缩进问题。 ", -1)),
                                  _createElementVNode("div", _hoisted_66, [
                                    ...
                                    _cache[65] || (_cache[65] = _createElementVNode("span", { class: "mcr-title-config-mode" }, " 开启后自动补全使用「服务器名_媒体库名」；仅使用媒体库名时，同名库共用同一配置 ", -1)),
                                    _createVNode(_component_v_switch, {
                                    ...
                                    _createElementVNode("span", _hoisted_67, _toDisplayString(config.value.title_config_strict ? "必须使用标准 YAML 语法" : "允许常见中文符号和空格容错"), 1)
                                  ]),
                                  ...
                                  _createElementVNode("div", { class: "mcr-title-config-reference" }, [
                                    _cache[66] || (_cache[66] = _createElementVNode("div", { class: "mcr-title-config-reference__label" }, "格式参考", -1)),
                      ...
                      _createElementVNode("div", _hoisted_69, "前端 UI " + _toDisplayString(_unref(UI_REV)) + " · 主程序 v" + _toDisplayString(_unref(PROGRAM_VERSION)), 1)
                    ], 512)
                  ])
                ]),
...
const Config = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e8cb7967"]]);
